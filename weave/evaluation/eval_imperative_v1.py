...
class _LogScoreContext:
    ...
    def __init__(
        self, score_logger: ScoreLoggerV1, scorer: Scorer | dict | str, score_call: Call
    ):
...
class ScoreLoggerV1:
    ...
    This class is returned by `EvaluationLoggerV1.log_prediction()` and can be used
    ...
    def __enter__(self) -> ScoreLoggerV1:
...
class EvaluationLoggerV1:
    """This class provides an imperative interface for logging evaluations using the legacy call-based approach.
    ...
    Each time you log a prediction, you will get back a `ScoreLoggerV1` object.
    You can use this object to log scores and metadata for that specific
    prediction. For more information, see the `ScoreLoggerV1` class.
    ...
    def __init__(
        ...
        self._accumulated_predictions: list[ScoreLoggerV1] = []
        ...
        def predict_and_score(self: Evaluation, model: Model, example: dict) -> dict:
            ...
            # The actual output is explicitly replaced in ScoreLoggerV1.finish.
            return {
                "output": output,
                "scores": {},
                "model_latency": None,
    ...
    def log_prediction(
        ...
        Returns:
            ScoreLoggerV1 for logging scores and optionally finishing the prediction.
