...
def _get_history_metrics(
    ...
    run_name = artifactVersion.gql["createdBy"]["name"]
    project_name = artifactVersion.gql["createdBy"]["project"]["name"]
    entity_name = artifactVersion.gql["createdBy"]["project"]["entity"]["name"]
