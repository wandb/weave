        ...
        if hasattr(value, "message"):
            ...
            acc = Message(
                ...
                usage=Usage(
                    input_tokens=0,
                    output_tokens=0,
                    cache_read_input_tokens=getattr(msg_usage, "cache_read_input_tokens", None) or 0,
                    cache_creation_input_tokens=getattr(msg_usage, "cache_creation_input_tokens", None) or 0,
                ),
            )
        else:
