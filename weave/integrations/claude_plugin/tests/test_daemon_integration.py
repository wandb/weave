...
class TestDaemonToolBuffering:
    ...
    def test_parallel_tools_grouped_in_ui(self) -> None:
        ...
        buffer.add("t1", "Read", {"file": "a.py"}, base, "content a")
        buffer.add("t2", "Read", {"file": "b.py"}, base + timedelta(milliseconds=100), "content b")
        buffer.add("t3", "Read", {"file": "c.py"}, base + timedelta(milliseconds=200), "content c")
    ...
    def test_error_tools_marked_correctly(self) -> None:
        ...
        buffer.add("t1", "Bash", {"command": "exit 1"}, base, "error output", is_error=True)
    ...
    def test_mixed_parallel_and_sequential(self) -> None:
        ...
        buffer.add("t2", "Read", {}, base + timedelta(milliseconds=200), "r2")

        # Group 2: Single Edit (2 seconds later)
        buffer.add("t3", "Edit", {}, base + timedelta(seconds=2), "r3")

        # Group 3: 2 parallel Bash (4 seconds later)
        buffer.add("t4", "Bash", {}, base + timedelta(seconds=4), "r4")
        buffer.add("t5", "Bash", {}, base + timedelta(seconds=4, milliseconds=100), "r5")
