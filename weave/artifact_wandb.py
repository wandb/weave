...
class WandbArtifactRef(artifact_fs.FilesystemArtifactRef):
    ...
    def ui_url(self):
        ...
        if issubclass(root_type, OpDefType):
            return f"http://localhost:3000/browse3/{self.artifact.uri_obj.entity_name}/{self.artifact.uri_obj.project_name}/ops/{self.artifact.uri_obj.name}/versions/{self.artifact.uri_obj.version}"
        else:
            return f"http://localhost:3000/browse3/{self.artifact.uri_obj.entity_name}/{self.artifact.uri_obj.project_name}/objects/{self.artifact.uri_obj.name}/versions/{self.artifact.uri_obj.version}"
