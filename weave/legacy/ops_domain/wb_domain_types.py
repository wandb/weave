...
from weave.legacy.decorator_type import type as weave_type
from weave.legacy.partial_object import (
    PartialObject,
...
TagType = Tag.WeaveType()  # type: ignore
TagType = typing.cast(PartialObjectTypeGeneratorType, TagType)
