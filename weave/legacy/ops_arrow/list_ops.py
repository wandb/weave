...
from weave.query_api import op, type_of
...
from weave.legacy.arrow.constructors import (
    vectorized_container_constructor_preprocessor,
    vectorized_input_types,
)
from weave.legacy.arrow.convert import to_compare_safe
...
from weave.legacy.ops_arrow.vectorize import _apply_fn_node_with_tag_pushdown
from weave.legacy.ops_primitives import list_ as primitive_list
