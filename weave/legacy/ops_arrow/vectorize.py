...
from weave.legacy.arrow.arrow_tags import pushdown_list_tags
from weave.legacy.arrow.list_ import ArrowWeaveList
from weave.legacy.ops_arrow import arraylist_ops, convert_ops
from weave.legacy.ops_arrow.dict import preprocess_merge
...
def _create_manually_mapped_op(
    ...
    from weave.legacy.ops_arrow import dict
