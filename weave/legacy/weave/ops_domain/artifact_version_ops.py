...
from weave.legacy.weave import artifact_fs, artifact_wandb, input_provider
...
def _get_history_metrics(
    ...
    from weave.legacy.weave.compile import enable_compile
    from weave.legacy.weave.graph import ConstNode, OutputNode
