...
def board(
    ...
    control_items = [
        ...
        weave.legacy.panels.GroupPanel(input_node, id="data"),
    ]
    ...
    panels = [
        weave.legacy.panels.BoardPanel(title_var, id="title_panel"),
        weave.legacy.panels.BoardPanel(data_var, id="table"),
    ]
