...
@weave.op()
def module_doc(module: types.ModuleType) -> weave.legacy.ops.Markdown:
    return weave.legacy.ops.Markdown(module.__doc__ or "")
...
@weave.op()
def pyclass_doc(pyclass: type) -> weave.legacy.ops.Markdown:
    return weave.legacy.ops.Markdown(pyclass.__doc__ or "")
...
@weave.op()
def function_doc(pyfunction: types.FunctionType) -> weave.legacy.ops.Markdown:
    return weave.legacy.ops.Markdown(pyfunction.__doc__ or "")
        ...
        return weave.legacy.panels.Card(
            ...
            content=[
                weave.legacy.panels.CardTab(
                    name="Description",
                    content=weave.legacy.panels.PanelMarkdown(module.module_doc()),  # type: ignore
                ),
                weave.legacy.panels.CardTab(
                    name="Classes",
                    content=weave.legacy.panels.Table(
                        ...
                        columns=[
                            lambda c: weave.legacy.panels.WeaveLink(
                                c.class_name(),
    ...
    def render(self) -> weave.legacy.panels.Card:
        ...
        return weave.legacy.panels.Card(
            ...
            content=[
                weave.legacy.panels.CardTab(
                    name="Description",
                    content=weave.legacy.panels.PanelMarkdown(cls.pyclass_doc()),  # type: ignore
                ),
                weave.legacy.panels.CardTab(
                    name="Methods",
                    content=weave.legacy.panels.Table(
                        ...
                        columns=[
                            lambda m: weave.legacy.panels.WeaveLink(
                                m.function_name(),
    ...
    def render(self) -> weave.legacy.panels.Card:
        ...
        return weave.legacy.panels.Card(
            ...
            content=[
                weave.legacy.panels.CardTab(
                    name="Description",
                    content=weave.legacy.panels.PanelMarkdown(func.function_doc()),  # type: ignore
                ),
            ],
        )
