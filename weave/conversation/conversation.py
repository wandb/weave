...
class Tool(_SpanBase):
    ...
    def _build_attrs(self, *, conversation_id: str, include_content: bool) -> dict[str, Any]:
...
class SubAgent(_SpanBase):
    ...
    def _build_attrs(self, *, conversation_id: str, conversation_name: str) -> dict[str, Any]:
