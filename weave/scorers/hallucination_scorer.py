...
# Token budget thresholds for curtailing inputs/outputs when they exceed model_max_length
OUTPUT_TOKEN_CURTAILMENT_THRESHOLD = 1000
INPUT_TOKEN_ALLOCATION_RESERVE = 975
OUTPUT_TOKEN_RESERVATION_BUFFER = 1025
