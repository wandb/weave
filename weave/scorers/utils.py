...
def check_score_param_type(
    ...
    if not isinstance(param_value, expected_type):
        ...
        raise TypeError(
            ...
            "\n"
            "Example:\n"
            "`WeaveBiasScorerV1.score` expects a string to be passed to its `output` parameter, but receives a dict.\n"
            "Here we choose option 1 and subclass the `WeaveBiasScorerV1` scorer. We write a new `score` method that extracts a string "
