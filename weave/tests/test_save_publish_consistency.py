...
def test_simple_value_publish(user_by_api_key_in_context):
...
def test_simple_node_publish(user_by_api_key_in_context):
...
def test_structured_value_publish(user_by_api_key_in_context):
...
def test_structured_node_publish(user_by_api_key_in_context):
...
def test_referential_saved_value_publish(user_by_api_key_in_context):
...
def test_referential_saved_node_publish(user_by_api_key_in_context):
    ...
    _assert_path_contents(
        ...
        _test_referential_saved_node_contents(
            f"wandb-artifact:///{user_by_api_key_in_context.username}/weave_ops/function:55409408fe25aa970a51/obj"
        ),
    )
...
def test_referential_published_value_save(user_by_api_key_in_context):
    _test_referential_published_value(_test_save)


def test_referential_published_value_publish(user_by_api_key_in_context):
...
def test_referential_published_node_save(user_by_api_key_in_context):
    _test_referential_published_node(_test_save)


def test_referential_published_node_publish(user_by_api_key_in_context):
