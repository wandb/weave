...
def test_projection_timeout():
    ...
    result = projection_utils.perform_2D_projection_with_timeout(embeddings, "pca", {}, timeout=1e-6)
...
def test_projection_timeout_error_propagation():
    ...
    with pytest.raises(errors.WeaveInternalError):
        projection_utils.perform_2D_projection_with_timeout(embeddings, "pca", {}, timeout=1e4)
