...
def test_dataset_row_ref(client):
    ...
    inner = d2.rows[0]["a"]
    exp_ref = "weave:///shawn/test-project/object/Dataset:wu1Rdm8YstYlAiIAM3d1nFw4ji6lmzGZzcADjH9kycQ/attr/rows/id/XfhC9dNA5D4taMvhKT4MKN2uce7F56Krsyv4Q6mvVMA/key/a"
    assert inner == 5
