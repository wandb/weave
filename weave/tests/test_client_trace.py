...
from ..trace_server import graph_client_trace, clickhouse_trace_server_batched, trace_server_interface



@pytest.fixture()
def trace_client():
    clickhouse_trace_server = clickhouse_trace_server_batched.ClickHouseTraceServer("localhost", 8123, False)
