...
def test_ops_with_default_params(trace_client):
    ...
    assert inner_res.calls[2].inputs == {"a": 1, "b": 5, "_keys": ["a", "b"]}
    assert inner_res.calls[3].inputs == {"a": 1, "b": 10, "_keys": ["a", "b"]}
    assert inner_res.calls[4].inputs == {"a": 1, "b": 5, "_keys": ["a", "b"]}
    assert inner_res.calls[5].inputs == {"a": 1, "b": 5, "_keys": ["a", "b"]}
