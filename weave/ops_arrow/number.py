...
# because they are often used in vecotrized functions AND those vecotrized functions
...
boolean_output_type = ARROW_WEAVE_LIST_MAYBE_BOOLEAN_TYPE
...
@arrow_op(
    ...
    input_type=binary_input_type,
    output_type=boolean_output_type,
)
