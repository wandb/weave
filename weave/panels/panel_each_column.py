...
class EachColumnConfig(typing.Generic[RenderType]):
    ...
    pbLayoutConfig: typing.Optional[PanelBankSectionConfig] = dataclasses.field(default_factory=lambda: None)
...
class EachColumn(panel.Panel):
    id = "EachColumn"
    config: typing.Optional[EachColumnConfig] = dataclasses.field(default_factory=lambda: None)
