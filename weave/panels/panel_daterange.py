...
class DateRangeConfig:
    domain: weave.Node[list[str]] = dataclasses.field(default_factory=lambda: graph.VoidNode())


@weave.type()
class DateRange(panel.Panel):
    id = "DateRange"
    config: typing.Optional[DateRangeConfig] = dataclasses.field(default_factory=DateRangeConfig)
