...
# @op(
#     input_type={"zipped":types.List(types.TypedDict({"0": types.Any(),"1": types.Any()}))},
# )
...
#     refine_output_type=_zip_to_dict_refine
# )
# def zip_to_dict(zipped):
#     return {obj["0"]: obj["1"] for obj in zipped}

# @op(
#     name="zip",
#     input_type={"arr1": types.List(types.Any()), "arr2": types.List(types.Any())},
#     output_type=lambda input_types: types.List(types.TypedDict({"0": unwrap_const_type(input_types["arr1"]).object_type,"1": unwrap_const_type(input_types["arr2"]).object_type })),
# )
...
# # Total hack
# @op(
#     name="zipped-sortedHead",
#     input_type={"zipped":types.List(types.TypedDict({"0": types.Any(),"1": types.Any()})), "count": types.Number()},
#     output_type=lambda input_types: unwrap_const_type(input_types["zipped"]),
# )
# def zip_to_dict(zipped, count):
#     return zipped[:count]
