...
class ErrorCode:
    ...
    COMPLETION_PROMPT_RESOLUTION_FAILED = "COMPLETION_PROMPT_RESOLUTION_FAILED"
    COMPLETION_MODEL_SETUP_FAILED = "COMPLETION_MODEL_SETUP_FAILED"
    COMPLETION_MISSING_API_KEY = "COMPLETION_MISSING_API_KEY"
    COMPLETION_PROVIDER_AUTHENTICATION_ERROR = (
        "COMPLETION_PROVIDER_AUTHENTICATION_ERROR"
    )
    COMPLETION_PROVIDER_BAD_REQUEST = "COMPLETION_PROVIDER_BAD_REQUEST"
    COMPLETION_PROVIDER_RATE_LIMIT = "COMPLETION_PROVIDER_RATE_LIMIT"
    COMPLETION_PROVIDER_TIMEOUT = "COMPLETION_PROVIDER_TIMEOUT"
    COMPLETION_PROVIDER_CONNECTION_ERROR = "COMPLETION_PROVIDER_CONNECTION_ERROR"
    COMPLETION_PROVIDER_UNAVAILABLE = "COMPLETION_PROVIDER_UNAVAILABLE"
    COMPLETION_PROVIDER_INTERNAL_ERROR = "COMPLETION_PROVIDER_INTERNAL_ERROR"
    COMPLETION_PROVIDER_ERROR = "COMPLETION_PROVIDER_ERROR"
    COMPLETION_UNEXPECTED_ERROR = "COMPLETION_UNEXPECTED_ERROR"
...
class MissingLLMApiKeyError(Error):
    ...
    error_code: str = ErrorCode.COMPLETION_MISSING_API_KEY
