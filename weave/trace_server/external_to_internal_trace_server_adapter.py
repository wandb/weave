...
class ExternalTraceServer(tsi.FullTraceServerInterface):
    ...
    def otel_export(self, req: tsi.OtelExportReq) -> tsi.OtelExportRes:
        ...
        return self._ref_apply(self.wrapped.otel_export, req)
    ...
    def calls_query(self, req: tsi.CallsQueryReq) -> tsi.CallsQueryRes:
        ...
        res = self._ref_apply(self.wrapped.calls_query, req)
    ...
    def calls_query_stream(self, req: tsi.CallsQueryReq) -> Iterator[tsi.CallSchema]:
        ...
        res = self._stream_ref_apply(
            self.wrapped.calls_query_stream, req
        )
        for call in res:
            if call.project_id != req.project_id:
                raise ValueError("Internal Error - Project Mismatch")
    ...
    def calls_delete(self, req: tsi.CallsDeleteReq) -> tsi.CallsDeleteRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.calls_delete, req)
    ...
    def calls_query_stats(self, req: tsi.CallsQueryStatsReq) -> tsi.CallsQueryStatsRes:
        ...
        if req.filter is not None:
            ...
            # TODO: How do we correctly process user_id for the query filters?
        return self._ref_apply(self.wrapped.calls_query_stats, req)

    def call_update(self, req: tsi.CallUpdateReq) -> tsi.CallUpdateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.call_update, req)
    ...
    def obj_create(self, req: tsi.ObjCreateReq) -> tsi.ObjCreateRes:
        ...
        return self._ref_apply(self.wrapped.obj_create, req)

    def obj_read(self, req: tsi.ObjReadReq) -> tsi.ObjReadRes:
        original_project_id = req.project_id
        req.project_id = self._idc.ext_to_int_project_id(original_project_id)
        res = self._ref_apply(self.wrapped.obj_read, req)
    ...
    def objs_query(self, req: tsi.ObjQueryReq) -> tsi.ObjQueryRes:
        original_project_id = req.project_id
        req.project_id = self._idc.ext_to_int_project_id(original_project_id)
        res = self._ref_apply(self.wrapped.objs_query, req)
        for obj in res.objs:
    ...
    def obj_delete(self, req: tsi.ObjDeleteReq) -> tsi.ObjDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.obj_delete, req)

    def table_create(self, req: tsi.TableCreateReq) -> tsi.TableCreateRes:
        req.table.project_id = self._idc.ext_to_int_project_id(req.table.project_id)
        return self._ref_apply(self.wrapped.table_create, req)

    def table_update(self, req: tsi.TableUpdateReq) -> tsi.TableUpdateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.table_update, req)
    ...
    def table_create_from_digests(
        ...
        return self._ref_apply(
            self.wrapped.table_create_from_digests, req
        )

    def table_query(self, req: tsi.TableQueryReq) -> tsi.TableQueryRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.table_query, req)
    ...
    def table_query_stream(
        ...
        return self._stream_ref_apply(
            self.wrapped.table_query_stream, req
        )

    # This is a legacy endpoint, it should be removed once the client is mostly updated
    def table_query_stats(self, req: tsi.TableQueryStatsReq) -> tsi.TableQueryStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.table_query_stats, req)

    def table_query_stats_batch(
        self, req: tsi.TableQueryStatsBatchReq
    ) -> tsi.TableQueryStatsBatchRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.table_query_stats_batch, req)

    def refs_read_batch(self, req: tsi.RefsReadBatchReq) -> tsi.RefsReadBatchRes:
        return self._ref_apply(self.wrapped.refs_read_batch, req)

    def file_create(self, req: tsi.FileCreateReq) -> tsi.FileCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        # Special case where refs can never be part of the request
        return self.wrapped.file_create(req)

    def file_content_read(self, req: tsi.FileContentReadReq) -> tsi.FileContentReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        # Special case where refs can never be part of the request
        return self.wrapped.file_content_read(req)

    def files_stats(self, req: tsi.FilesStatsReq) -> tsi.FilesStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.files_stats, req)
    ...
    def feedback_create(self, req: tsi.FeedbackCreateReq) -> tsi.FeedbackCreateRes:
        ...
        res = self._ref_apply(self.wrapped.feedback_create, req)
    ...
    def feedback_create_batch(
        ...
        res = self._ref_apply(self.wrapped.feedback_create_batch, req)
        return res
    ...
    def feedback_query(self, req: tsi.FeedbackQueryReq) -> tsi.FeedbackQueryRes:
        ...
        res = self._ref_apply(self.wrapped.feedback_query, req)
    ...
    def feedback_purge(self, req: tsi.FeedbackPurgeReq) -> tsi.FeedbackPurgeRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.feedback_purge, req)
    ...
    def feedback_replace(self, req: tsi.FeedbackReplaceReq) -> tsi.FeedbackReplaceRes:
        ...
        if original_user_id is None:
            raise ValueError("wb_user_id cannot be None")
        req.wb_user_id = self._idc.ext_to_int_user_id(original_user_id)
        res = self._ref_apply(self.wrapped.feedback_replace, req)
        if res.wb_user_id != req.wb_user_id:
            raise ValueError("Internal Error - User Mismatch")
        res.wb_user_id = original_user_id
        return res
    ...
    def cost_create(self, req: tsi.CostCreateReq) -> tsi.CostCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.cost_create, req)

    def cost_purge(self, req: tsi.CostPurgeReq) -> tsi.CostPurgeRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.cost_purge, req)

    def cost_query(self, req: tsi.CostQueryReq) -> tsi.CostQueryRes:
        original_project_id = req.project_id
        req.project_id = self._idc.ext_to_int_project_id(original_project_id)
        res = self._ref_apply(self.wrapped.cost_query, req)
    ...
    def actions_execute_batch(
        ...
        if original_user_id is None:
            raise ValueError("wb_user_id cannot be None")
        req.wb_user_id = self._idc.ext_to_int_user_id(original_user_id)
        res = self._ref_apply(self.wrapped.actions_execute_batch, req)
        return res
    ...
    def completions_create(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        res = self._ref_apply(self.wrapped.completions_create, req)
        return res
    ...
    def completions_create_stream(
        ...
        return self.wrapped.completions_create_stream(req)

    def image_create(
        self, req: tsi.ImageGenerationCreateReq
    ) -> tsi.ImageGenerationCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        res = self._ref_apply(self.wrapped.image_create, req)
        return res

    def project_stats(self, req: tsi.ProjectStatsReq) -> tsi.ProjectStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.project_stats, req)
    ...
    def threads_query_stream(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(
            self.wrapped.threads_query_stream, req
        )
    ...
    def evaluation_run_create(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.evaluation_run_create, req)

    def evaluation_run_read(
        self, req: tsi.EvaluationRunReadReq
    ) -> tsi.EvaluationRunReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.evaluation_run_read, req)
    ...
    def evaluation_run_list(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(
            self.wrapped.evaluation_run_list, req
        )
    ...
    def evaluation_run_delete(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.evaluation_run_delete, req)
    ...
    def evaluation_run_finish(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.evaluation_run_finish, req)
    ...
    def prediction_create(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.prediction_create, req)
    ...
    def prediction_read(self, req: tsi.PredictionReadReq) -> tsi.PredictionReadRes:
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self.wrapped.prediction_read, req)
    ...
    def prediction_list(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self.wrapped.prediction_list, req)
    ...
    def prediction_delete(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.prediction_delete, req)
    ...
    def prediction_finish(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.prediction_finish, req)
    ...
    def score_delete(self, req: tsi.ScoreDeleteReq) -> tsi.ScoreDeleteRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self.wrapped.score_delete, req)
