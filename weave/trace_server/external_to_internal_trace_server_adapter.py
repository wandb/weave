...
class ExternalTraceServer(tsi.FullTraceServerInterface):
    ...
    def insights_context_query(
        self, req: tsi.insights_types.InsightContextQueryReq
    ) -> tsi.insights_types.InsightContextQueryRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._internal_trace_server.insights_context_query(req)
