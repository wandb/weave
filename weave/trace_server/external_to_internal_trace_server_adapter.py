...
class ExternalTraceServer(tsi.FullTraceServerInterface):
    ...
    def _make_project_verifier(
        self, internal_project_id: str
    ) -> Callable[[str], bool]:
        """Build a verifier that accepts internal project IDs.

        Accepts the request's own project_id via a fast set lookup, and falls
        back to an access check (int_to_ext_project_id) for cross-project refs.
        """
        allowed = {internal_project_id}
    ...
    def _ref_apply(
        ...
        req_conv = universal_ext_to_int_ref_converter(
            ...
            verify_internal_project_id=self._make_project_verifier(
                internal_project_id
            ),
        )
        res = method(req_conv)
    ...
    def projects_info(self, req: tsi.ProjectsInfoReq) -> list[tsi.ProjectsInfoRes]:
        ...
        Not part of FullTraceServerInterface; defined here because
        WeaveClient._resolve_internal_project_id discovers it via hasattr
        duck-typing to enable client-side digest computation.
        """
        return [
            tsi.ProjectsInfoRes(
    ...
    def otel_export(self, req: tsi.OTelExportReq) -> tsi.OTelExportRes:
        ...
        return self._ref_apply(self._internal_trace_server.otel_export, req, req.project_id)
    ...
    def call_start(self, req: tsi.CallStartReq) -> tsi.CallStartRes:
        ...
        return self._ref_apply(self._internal_trace_server.call_start, req, req.start.project_id)

    def call_end(self, req: tsi.CallEndReq) -> tsi.CallEndRes:
        req.end.project_id = self._idc.ext_to_int_project_id(req.end.project_id)
        return self._ref_apply(self._internal_trace_server.call_end, req, req.end.project_id)

    def call_read(self, req: tsi.CallReadReq) -> tsi.CallReadRes:
        original_project_id = req.project_id
        req.project_id = self._idc.ext_to_int_project_id(original_project_id)
        res = self._ref_apply(self._internal_trace_server.call_read, req, req.project_id)
        if res.call is None:
            return res
    ...
    def calls_query(self, req: tsi.CallsQueryReq) -> tsi.CallsQueryRes:
        ...
        res = self._ref_apply(self._internal_trace_server.calls_query, req, req.project_id)
    ...
    def calls_delete(self, req: tsi.CallsDeleteReq) -> tsi.CallsDeleteRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.calls_delete, req, req.project_id)
    ...
    def calls_query_stats(self, req: tsi.CallsQueryStatsReq) -> tsi.CallsQueryStatsRes:
        ...
        if req.filter is not None:
            ...
            # TODO: How do we correctly process user_id for the query filters?
        return self._ref_apply(self._internal_trace_server.calls_query_stats, req, req.project_id)

    def call_update(self, req: tsi.CallUpdateReq) -> tsi.CallUpdateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.call_update, req, req.project_id)
    ...
    def obj_create(self, req: tsi.ObjCreateReq) -> tsi.ObjCreateRes:
        ...
        return self._ref_apply(self._internal_trace_server.obj_create, req, req.obj.project_id)
    ...
    def objs_query(self, req: tsi.ObjQueryReq) -> tsi.ObjQueryRes:
        original_project_id = req.project_id
        req.project_id = self._idc.ext_to_int_project_id(original_project_id)
        res = self._ref_apply(self._internal_trace_server.objs_query, req, req.project_id)
        for obj in res.objs:
    ...
    def obj_delete(self, req: tsi.ObjDeleteReq) -> tsi.ObjDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.obj_delete, req, req.project_id)
    ...
    def table_create(self, req: tsi.TableCreateReq) -> tsi.TableCreateRes:
        ...
        return self._ref_apply(self._internal_trace_server.table_create, req, req.table.project_id)

    def table_update(self, req: tsi.TableUpdateReq) -> tsi.TableUpdateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.table_update, req, req.project_id)
    ...
    def table_query(self, req: tsi.TableQueryReq) -> tsi.TableQueryRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.table_query, req, req.project_id)
    ...
    def table_query_stats(self, req: tsi.TableQueryStatsReq) -> tsi.TableQueryStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.table_query_stats, req, req.project_id)

    def table_query_stats_batch(
        self, req: tsi.TableQueryStatsBatchReq
    ) -> tsi.TableQueryStatsBatchRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.table_query_stats_batch, req, req.project_id)
    ...
    def refs_read_batch(self, req: tsi.RefsReadBatchReq) -> tsi.RefsReadBatchRes:
        ...
        # verified via the access-check fallback.
        req_conv = universal_ext_to_int_ref_converter(
            req,
            self._idc.ext_to_int_project_id,
            verify_internal_project_id=lambda pid: (
    ...
    def files_stats(self, req: tsi.FilesStatsReq) -> tsi.FilesStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.files_stats, req, req.project_id)
    ...
    def feedback_create(self, req: tsi.FeedbackCreateReq) -> tsi.FeedbackCreateRes:
        ...
        res = self._ref_apply(self._internal_trace_server.feedback_create, req, req.project_id)
    ...
    def feedback_create_batch(
        ...
        res = self._ref_apply(self._internal_trace_server.feedback_create_batch, req, pid)
        return res
    ...
    def feedback_query(self, req: tsi.FeedbackQueryReq) -> tsi.FeedbackQueryRes:
        ...
        res = self._ref_apply(self._internal_trace_server.feedback_query, req, req.project_id)
    ...
    def feedback_purge(self, req: tsi.FeedbackPurgeReq) -> tsi.FeedbackPurgeRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.feedback_purge, req, req.project_id)
    ...
    def feedback_replace(self, req: tsi.FeedbackReplaceReq) -> tsi.FeedbackReplaceRes:
        ...
        if original_user_id is None:
            raise ValueError("wb_user_id cannot be None")
        req.wb_user_id = self._idc.ext_to_int_user_id(original_user_id)
        res = self._ref_apply(self._internal_trace_server.feedback_replace, req, req.project_id)
        if res.wb_user_id != req.wb_user_id:
            raise ValueError("Internal Error - User Mismatch")
        res.wb_user_id = original_user_id
        return res
    ...
    def cost_create(self, req: tsi.CostCreateReq) -> tsi.CostCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.cost_create, req, req.project_id)

    def cost_purge(self, req: tsi.CostPurgeReq) -> tsi.CostPurgeRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.cost_purge, req, req.project_id)

    def cost_query(self, req: tsi.CostQueryReq) -> tsi.CostQueryRes:
        original_project_id = req.project_id
        req.project_id = self._idc.ext_to_int_project_id(original_project_id)
        res = self._ref_apply(self._internal_trace_server.cost_query, req, req.project_id)
    ...
    def actions_execute_batch(
        ...
        if original_user_id is None:
            raise ValueError("wb_user_id cannot be None")
        req.wb_user_id = self._idc.ext_to_int_user_id(original_user_id)
        res = self._ref_apply(self._internal_trace_server.actions_execute_batch, req, req.project_id)
        return res
    ...
    def completions_create(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        res = self._ref_apply(self._internal_trace_server.completions_create, req, req.project_id)
        return res
    ...
    def image_create(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        res = self._ref_apply(self._internal_trace_server.image_create, req, req.project_id)
        return res

    def project_stats(self, req: tsi.ProjectStatsReq) -> tsi.ProjectStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.project_stats, req, req.project_id)
    ...
    def annotation_queue_create(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.annotation_queue_create, req, req.project_id)
    ...
    def annotation_queues_query_stream(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(
            self._internal_trace_server.annotation_queues_query_stream, req, req.project_id
        )
    ...
    def annotation_queue_read(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.annotation_queue_read, req, req.project_id)

    def annotation_queue_update(
        self, req: tsi.AnnotationQueueUpdateReq
    ) -> tsi.AnnotationQueueUpdateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.annotation_queue_update, req, req.project_id)

    def annotation_queue_delete(
        self, req: tsi.AnnotationQueueDeleteReq
    ) -> tsi.AnnotationQueueDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.annotation_queue_delete, req, req.project_id)
    ...
    def annotation_queues_stats(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.annotation_queues_stats, req, req.project_id)
    ...
    def evaluate_model(self, req: tsi.EvaluateModelReq) -> tsi.EvaluateModelRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.evaluate_model, req, req.project_id)

    def evaluation_status(
        self, req: tsi.EvaluationStatusReq
    ) -> tsi.EvaluationStatusRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.evaluation_status, req, req.project_id)
    ...
    def calls_score(self, req: tsi.CallsScoreReq) -> tsi.CallsScoreRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.calls_score, req, req.project_id)

    # === V2 APIs ===

    def call_stats(self, req: tsi.CallStatsReq) -> tsi.CallStatsRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.call_stats, req, req.project_id)

    def trace_usage(self, req: tsi.TraceUsageReq) -> tsi.TraceUsageRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.trace_usage, req, req.project_id)

    def calls_usage(self, req: tsi.CallsUsageReq) -> tsi.CallsUsageRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.calls_usage, req, req.project_id)

    def op_create(self, req: tsi.OpCreateReq) -> tsi.OpCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.op_create, req, req.project_id)
    ...
    def op_list(self, req: tsi.OpListReq) -> Iterator[tsi.OpReadRes]:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.op_list, req, req.project_id)

    def op_delete(self, req: tsi.OpDeleteReq) -> tsi.OpDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.op_delete, req, req.project_id)

    def dataset_create(self, req: tsi.DatasetCreateReq) -> tsi.DatasetCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.dataset_create, req, req.project_id)

    def dataset_read(self, req: tsi.DatasetReadReq) -> tsi.DatasetReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.dataset_read, req, req.project_id)

    def dataset_list(self, req: tsi.DatasetListReq) -> Iterator[tsi.DatasetReadRes]:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.dataset_list, req, req.project_id)

    def dataset_delete(self, req: tsi.DatasetDeleteReq) -> tsi.DatasetDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.dataset_delete, req, req.project_id)

    def scorer_create(self, req: tsi.ScorerCreateReq) -> tsi.ScorerCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.scorer_create, req, req.project_id)

    def scorer_read(self, req: tsi.ScorerReadReq) -> tsi.ScorerReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.scorer_read, req, req.project_id)

    def scorer_list(self, req: tsi.ScorerListReq) -> Iterator[tsi.ScorerReadRes]:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.scorer_list, req, req.project_id)

    def scorer_delete(self, req: tsi.ScorerDeleteReq) -> tsi.ScorerDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.scorer_delete, req, req.project_id)

    def evaluation_create(
        self, req: tsi.EvaluationCreateReq
    ) -> tsi.EvaluationCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.evaluation_create, req, req.project_id)

    def evaluation_read(self, req: tsi.EvaluationReadReq) -> tsi.EvaluationReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.evaluation_read, req, req.project_id)

    def evaluation_list(
        self, req: tsi.EvaluationListReq
    ) -> Iterator[tsi.EvaluationReadRes]:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.evaluation_list, req, req.project_id)

    def evaluation_delete(
        self, req: tsi.EvaluationDeleteReq
    ) -> tsi.EvaluationDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.evaluation_delete, req, req.project_id)

    # Model V2 API

    def model_create(self, req: tsi.ModelCreateReq) -> tsi.ModelCreateRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.model_create, req, req.project_id)

    def model_read(self, req: tsi.ModelReadReq) -> tsi.ModelReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.model_read, req, req.project_id)

    def model_list(self, req: tsi.ModelListReq) -> Iterator[tsi.ModelReadRes]:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.model_list, req, req.project_id)

    def model_delete(self, req: tsi.ModelDeleteReq) -> tsi.ModelDeleteRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.model_delete, req, req.project_id)
    ...
    def evaluation_run_create(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.evaluation_run_create, req, req.project_id)

    def evaluation_run_read(
        self, req: tsi.EvaluationRunReadReq
    ) -> tsi.EvaluationRunReadRes:
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.evaluation_run_read, req, req.project_id)
    ...
    def evaluation_run_delete(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.evaluation_run_delete, req, req.project_id)
    ...
    def evaluation_run_finish(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.evaluation_run_finish, req, req.project_id)
    ...
    def prediction_create(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.prediction_create, req, req.project_id)
    ...
    def prediction_read(self, req: tsi.PredictionReadReq) -> tsi.PredictionReadRes:
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.prediction_read, req, req.project_id)
    ...
    def prediction_list(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.prediction_list, req, req.project_id)
    ...
    def prediction_delete(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.prediction_delete, req, req.project_id)
    ...
    def prediction_finish(
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.prediction_finish, req, req.project_id)
    ...
    def score_create(self, req: tsi.ScoreCreateReq) -> tsi.ScoreCreateRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.score_create, req, req.project_id)

    def score_read(self, req: tsi.ScoreReadReq) -> tsi.ScoreReadRes:
        """Read a score, converting project_id and scorer ref."""
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.score_read, req, req.project_id)

    def score_list(self, req: tsi.ScoreListReq) -> Iterator[tsi.ScoreReadRes]:
        """List scores, converting project_id and scorer refs."""
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._stream_ref_apply(self._internal_trace_server.score_list, req, req.project_id)
    ...
    def score_delete(self, req: tsi.ScoreDeleteReq) -> tsi.ScoreDeleteRes:
        ...
        if req.wb_user_id is not None:
            req.wb_user_id = self._idc.ext_to_int_user_id(req.wb_user_id)
        return self._ref_apply(self._internal_trace_server.score_delete, req, req.project_id)
    ...
    def eval_results_query(
        ...
        req.project_id = self._idc.ext_to_int_project_id(req.project_id)
        return self._ref_apply(self._internal_trace_server.eval_results_query, req, req.project_id)
    ...
    def call_start_v2(self, req: tsi.CallStartV2Req) -> tsi.CallStartV2Res:
        ...
        if req.start.wb_user_id is not None:
            req.start.wb_user_id = self._idc.ext_to_int_user_id(req.start.wb_user_id)
        return self._ref_apply(self._internal_trace_server.call_start_v2, req, req.start.project_id)

    def call_end_v2(self, req: tsi.CallEndV2Req) -> tsi.CallEndV2Res:
        """End a single call (v2), converting project_id."""
        req.end.project_id = self._idc.ext_to_int_project_id(req.end.project_id)
        return self._ref_apply(self._internal_trace_server.call_end_v2, req, req.end.project_id)
