...
class RemoteHTTPTraceServer(tsi.TraceServerInterface):
    ...
    def feedback_create(self, req: t.Union[tsi.FeedbackCreateReq, t.Dict[str, t.Any]]) -> tsi.FeedbackCreateRes:
        return self._generic_request("/feedback/create", req, tsi.FeedbackCreateReq, tsi.FeedbackCreateRes)

    def feedback_query(self, req: t.Union[tsi.FeedbackQueryReq, t.Dict[str, t.Any]]) -> tsi.FeedbackQueryRes:
        return self._generic_request("/feedback/query", req, tsi.FeedbackQueryReq, tsi.FeedbackQueryRes)

    def feedback_purge(self, req: t.Union[tsi.FeedbackPurgeReq, t.Dict[str, t.Any]]) -> tsi.FeedbackPurgeRes:
