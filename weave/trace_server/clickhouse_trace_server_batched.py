...
class ClickHouseTraceServer(tsi.FullTraceServerInterface):
    ...
    def object_interface(self) -> oi.ObjectInterface:
        """Get the object-oriented API interface.

        Returns a ClickhouseObjectInterface instance that provides clean, RESTful
        APIs for Ops, Datasets, Scorers, Evaluations, Models, Evaluation Runs,
        Predictions, and Scores.
        """
        return ClickhouseObjectInterface(self)
...
class ClickhouseObjectInterface(oi.ObjectInterface):
    """ClickHouse implementation of the ObjectInterface protocol.

    This class provides the clean, RESTful object-oriented APIs for Ops, Datasets,
    Scorers, Evaluations, Models, Evaluation Runs, Predictions, and Scores by
    delegating to the underlying ClickHouseTraceServer implementation.
    """

    def __init__(self, clickhouse_server: ClickHouseTraceServer) -> None:
        """Initialize the ClickhouseObjectInterface.

        Args:
            clickhouse_server: The underlying ClickHouseTraceServer instance to delegate to
        """
        self._server = clickhouse_server

    # ============================================================================
    # Op API Implementation
    # ============================================================================
    ...
    def op_create(self, req: oi.OpCreateReq) -> oi.OpCreateRes:
        ...
        source_file_res = self._server.file_create(source_file_req)
        ...
        obj_result = self._server.obj_create(obj_req)
        ...
        obj_read_res = self._server._obj_read_with_retry(obj_read_req)

        return oi.OpCreateRes(
            digest=obj_result.digest,
            object_id=object_id,
    ...
    def op_read(self, req: oi.OpReadReq) -> oi.OpReadRes:
        ...
        object_query_builder.add_digests_conditions(req.digest)
        object_query_builder.set_include_deleted(include_deleted=True)
        objs = self._server._select_objs_query(object_query_builder)
        if len(objs) == 0:
        ...
        if object_creation_utils.OP_SOURCE_FILE_NAME in files:
            ...
            try:
                file_content_res = self._server.file_content_read(
    ...
    def op_list(self, req: oi.OpListReq) -> Iterator[oi.OpReadRes]:
        ...
        if complex_query:
            ...
            objs = self._server._select_objs_query(
                object_query_builder, metadata_only=False
            )
        else:
            ...
            obj_res = self._server.objs_query(obj_query_req)
            objs = obj_res.objs
    ...
    def op_delete(self, req: oi.OpDeleteReq) -> oi.OpDeleteRes:
        ...
        object_versions = self._server._select_objs_query(
            object_query_builder, metadata_only
        )
        ...
        obj_delete_res = self._server.obj_delete(obj_delete_req)

        return oi.OpDeleteRes(num_deleted=obj_delete_res.num_deleted)
    ...
    def dataset_create(self, req: oi.DatasetCreateReq) -> oi.DatasetCreateRes:
        ...
        table_res = self._server.table_create(table_req)
    ...
    def dataset_read(self, req: oi.DatasetReadReq) -> oi.DatasetReadRes:
        ...
        result = self._server._obj_read_with_retry(obj_req)
        val = result.obj.val
    ...
    def dataset_delete(self, req: oi.DatasetDeleteReq) -> oi.DatasetDeleteRes:
        ...
        return oi.DatasetDeleteRes(num_deleted=result.num_deleted)

    # ============================================================================
    # Scorer API Implementation
    # ============================================================================
    ...
    def scorer_create(self, req: oi.ScorerCreateReq) -> oi.ScorerCreateRes:
        ...
        summarize_op_req = oi.OpCreateReq(
            project_id=req.project_id,
    ...
    def scorer_delete(self, req: oi.ScorerDeleteReq) -> oi.ScorerDeleteRes:
        ...
        result = self._server.obj_delete(obj_delete_req)
        return oi.ScorerDeleteRes(num_deleted=result.num_deleted)
    ...
    def evaluation_create(self, req: oi.EvaluationCreateReq) -> oi.EvaluationCreateRes:
        ...
        evaluate_op_req = oi.OpCreateReq(
            project_id=req.project_id,
        ...
        predict_and_score_op_req = oi.OpCreateReq(
            project_id=req.project_id,
    ...
    def evaluation_list(
        ...
        result = self._server.objs_query(obj_query_req)
    ...
    def model_read(self, req: oi.ModelReadReq) -> oi.ModelReadRes:
        ...
        obj_read_res = self._server.obj_read(obj_read_req)
        ...
        file_content_res = self._server.file_content_read(file_content_req)
    ...
    def model_list(self, req: oi.ModelListReq) -> Iterator[oi.ModelReadRes]:
        ...
        obj_query_res = self._server.objs_query(obj_query_req)
    ...
    def model_delete(self, req: oi.ModelDeleteReq) -> oi.ModelDeleteRes:
        ...
        result = self._server.obj_delete(obj_delete_req)
        return oi.ModelDeleteRes(num_deleted=result.num_deleted)

    # ============================================================================
    # Evaluation Run API Implementation
    # ============================================================================
    ...
    def evaluation_run_create(
        ...
        self._server.call_start(call_start_req)

        return oi.EvaluationRunCreateRes(evaluation_run_id=evaluation_run_id)
    ...
    def evaluation_run_read(
        ...
        call_res = self._server.call_read(call_read_req)
        ...
        return oi.EvaluationRunReadRes(
    ...
    def evaluation_run_list(
        ...
        for call in self._server.calls_query_stream(calls_query_req):
            attributes = call.attributes.get(constants.WEAVE_ATTRIBUTES_NAMESPACE, {})
            status = determine_call_status(call)

            yield oi.EvaluationRunReadRes(
                evaluation_run_id=call.id,
    ...
    def evaluation_run_delete(
        ...
        res = self._server.calls_delete(calls_delete_req)
        return oi.EvaluationRunDeleteRes(num_deleted=res.num_deleted)
    ...
    def evaluation_run_finish(
        ...
        evaluation_run_call = self._server.call_read(evaluation_run_read_req).call
        evaluation_ref = None
        ...
        self._server.call_start(summarize_start_req)
        ...
        self._server.call_end(summarize_end_req)
    ...
    def prediction_create(self, req: oi.PredictionCreateReq) -> oi.PredictionCreateRes:
        ...
        if req.evaluation_run_id:
            ...
            eval_run_read_res = self._server.call_read(evaluation_run_read_req)
            ...
            self._server.call_start(predict_and_score_start_req)
        ...
        return oi.PredictionCreateRes(prediction_id=prediction_id)
    ...
    def prediction_read(self, req: oi.PredictionReadReq) -> oi.PredictionReadRes:
        ...
        if evaluation_run_id is None and call.parent_id:
            ...
            parent_res = self._server.call_read(parent_read_req)
    ...
    def prediction_delete(self, req: oi.PredictionDeleteReq) -> oi.PredictionDeleteRes:
        ...
        res = self._server.calls_delete(calls_delete_req)
        return oi.PredictionDeleteRes(num_deleted=res.num_deleted)
    ...
    def prediction_finish(self, req: oi.PredictionFinishReq) -> oi.PredictionFinishRes:
        ...
        prediction_res = self._server.call_read(prediction_read_req)
        ...
        for score_call in self._server.calls_query_stream(calls_query_req):
    ...
    def score_create(self, req: oi.ScoreCreateReq) -> oi.ScoreCreateRes:
        ...
        return oi.ScoreCreateRes(score_id=score_id)
    ...
    def score_delete(self, req: oi.ScoreDeleteReq) -> oi.ScoreDeleteRes:
        ...
        res = self._server.calls_delete(calls_delete_req)
        return oi.ScoreDeleteRes(num_deleted=res.num_deleted)
