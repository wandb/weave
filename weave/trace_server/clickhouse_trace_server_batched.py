...
class ClickHouseTraceServer(tsi.FullTraceServerInterface):
    ...
    def annotation_queue_create(
        ...
        # Default claim_timeout_seconds if not provided
        claim_timeout_seconds = req.claim_timeout_seconds or 1800
    ...
    def annotation_queues_query_stream(
        ...
        for row in raw_res:
            ...
            due_date_with_tz = _ensure_datetimes_have_tz(due_date)
    ...
    def annotation_queue_read(
        ...
        queue = tsi.AnnotationQueueSchema(
            ...
            due_date=_ensure_datetimes_have_tz(row["due_date"]),
    ...
    def annotation_queue_add_calls(
        ...
        # Step 3: Create queue items and progress records
        queue_items_rows = []
        progress_rows = []
        ...
        for call in calls_data:
            ...
            # Progress record row (must be tuple in column order)
        ...
        # Step 5: Batch insert progress records
        self.ch_client.insert(
