    ...
    def mapper(obj: B) -> B:
        if isinstance(obj, str):
            if obj.startswith(weave_prefix):
                ...
                # Pass through refs that are already in internal format.
                # This supports clients that pre-convert refs using the
                # project_id_map from the projects_info endpoint.
                return obj
        return obj
