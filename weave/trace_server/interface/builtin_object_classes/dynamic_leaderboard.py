...
class ObjectVersionGroups(BaseModel):
    group_mapping: list[VersionGroup] # List of versions of the object to group together
...
class DynamicLeaderboard(base_object_def.BaseObject):
    calls_query: str  # The query used by the UI to filter rows. If none, use all entries
