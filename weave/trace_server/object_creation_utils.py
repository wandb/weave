...
def get_placeholder_op_source() -> str:
    """Get placeholder source code for an Op.

    Returns:
        Python source code for a placeholder op function
    """
    return """def func(*args, **kwargs):
    ... # Code-capture unavailable for this op
"""


def get_default_summarize_op_source() -> str:
    """Get default source code for a Scorer's summarize op.

    This is the default implementation that all Scorers use unless overridden.

    Returns:
        Python source code for the default summarize method
    """
    return """def summarize(score_rows: list) -> dict | None:
