...
class SqliteTraceServer(tsi.FullTraceServerInterface):
    ...
    def object_interface(self) -> oi.ObjectInterface:
        return SqliteObjectsInterface(self)
...
class SqliteObjectsInterface(oi.ObjectInterface):
    """Implementation of ObjectInterface for SqliteTraceServer."""
    ...
    def op_read(self, req: oi.OpReadReq) -> oi.OpReadRes:
        ...
        result = self._server.obj_read(obj_req)
    ...
    def op_delete(self, req: oi.OpDeleteReq) -> oi.OpDeleteRes:
        ...
        return oi.OpDeleteRes(num_deleted=result.num_deleted)
    ...
    def evaluation_run_delete(
        ...
        self._server.calls_delete(calls_delete_req)
        return oi.EvaluationRunDeleteRes(num_deleted=len(req.evaluation_run_ids))
    ...
    def evaluation_run_finish(
        ...
        evaluation_run_read_res = self._server.call_read(evaluation_run_read_req)
        ...
        predict_and_score_calls = self._server.calls_query_stream(calls_query_req)
    ...
    def prediction_create(self, req: oi.PredictionCreateReq) -> oi.PredictionCreateRes:
        ...
        if req.evaluation_run_id:
            ...
            evaluation_run_call = self._server.call_read(evaluation_run_read_req)
            evaluation_ref = (
    ...
    def prediction_delete(self, req: oi.PredictionDeleteReq) -> oi.PredictionDeleteRes:
        ...
        self._server.calls_delete(calls_delete_req)
        return oi.PredictionDeleteRes(num_deleted=len(req.prediction_ids))
    ...
    def score_create(self, req: oi.ScoreCreateReq) -> oi.ScoreCreateRes:
        ...
        self._server.feedback_create(feedback_req)
    ...
    def score_delete(self, req: oi.ScoreDeleteReq) -> oi.ScoreDeleteRes:
        ...
        self._server.calls_delete(calls_delete_req)
        return oi.ScoreDeleteRes(num_deleted=len(req.score_ids))
