"""BYOB storage resolver: maps `project_id` -> `ResolvedStorageTarget`.

Implements the fail-closed truth table from the spec (§4.3). Cache state, last
known status per project, and TTL handling live here. Singleflight, sweeper,
and pool are post-MVP.
"""
