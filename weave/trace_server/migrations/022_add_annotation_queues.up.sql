...
CREATE TABLE annotation_queues (
    ...
    */
    ...
    /*
    `claim_timeout_seconds`: Duration in seconds before a claimed item expires
    and can be reclaimed by another annotator. Default 30 minutes.
    */
    claim_timeout_seconds UInt32 DEFAULT 1800,

    /*
    `due_date`: Optional deadline for completing annotations in this queue.
...
CREATE TABLE annotator_queue_items_progress (
    ...
    */
    ...
    - pending (0): Available for claiming
    - claimed (1): Annotator has claimed, preventing duplicate work
    ...
    */
    ...
    /*
    `claimed_at`: Timestamp when the item was claimed. NULL if not claimed.
    */
    claimed_at Nullable(DateTime64(3)),

    /*
    `claim_expires_at`: Timestamp when the claim expires and can be reclaimed.
    NULL if not claimed. Calculated as claimed_at + claim_timeout_seconds.
    */
    claim_expires_at Nullable(DateTime64(3)),
