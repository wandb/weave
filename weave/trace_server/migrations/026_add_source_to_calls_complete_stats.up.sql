-- Add source column to calls_complete_stats so billing queries can filter
-- out migration rows (source = 'dual' or 'migration').

ALTER TABLE calls_complete_stats
    ADD COLUMN source SimpleAggregateFunction(any, String);
