...
class TraceServerInterface(Protocol):
    ...
    def genai_otel_export(
        ...
        Note: rejected spans don't block the rest of the batch.
        Inspect `res.error_message` for the rejection cause.
    ...
    def agent_conversation_chat(
        ...
        Note: a turn corresponds to one trace, not one
        `invoke_agent` span. A turn can contain zero, one, or many
        agent invocations.
