...
class TraceServerInterfaceV2(Protocol):
    ...
    # Ops
    async def op_create_v2(self, req: OpCreateV2Req) -> OpCreateV2Res: ...
    async def op_read_v2(self, req: OpReadV2Req) -> OpReadV2Res: ...
    async def op_list_v2(self, req: OpListV2Req) -> AsyncIterator[OpReadV2Res]: ...
    async def op_delete_v2(self, req: OpDeleteV2Req) -> OpDeleteV2Res: ...

    # Datasets
    async def dataset_create_v2(
        self, req: DatasetCreateV2Req
    ) -> DatasetCreateV2Res: ...
    async def dataset_read_v2(self, req: DatasetReadV2Req) -> DatasetReadV2Res: ...
    async def dataset_list_v2(
        self, req: DatasetListV2Req
    ) -> AsyncIterator[DatasetReadV2Res]: ...
    async def dataset_delete_v2(
        self, req: DatasetDeleteV2Req
    ) -> DatasetDeleteV2Res: ...

    # Scorers
    async def scorer_create_v2(self, req: ScorerCreateV2Req) -> ScorerCreateV2Res: ...
    async def scorer_read_v2(self, req: ScorerReadV2Req) -> ScorerReadV2Res: ...
    async def scorer_list_v2(
        self, req: ScorerListV2Req
    ) -> AsyncIterator[ScorerReadV2Res]: ...
    async def scorer_delete_v2(self, req: ScorerDeleteV2Req) -> ScorerDeleteV2Res: ...
    ...
    async def evaluation_read_v2(
        self, req: EvaluationReadV2Req
    ) -> EvaluationReadV2Res: ...
    async def evaluation_list_v2(
        self, req: EvaluationListV2Req
    ) -> AsyncIterator[EvaluationReadV2Res]: ...
    async def evaluation_delete_v2(
        self, req: EvaluationDeleteV2Req
    ) -> EvaluationDeleteV2Res: ...

    # Models
    async def model_create_v2(self, req: ModelCreateV2Req) -> ModelCreateV2Res: ...
    async def model_read_v2(self, req: ModelReadV2Req) -> ModelReadV2Res: ...
    async def model_list_v2(
        self, req: ModelListV2Req
    ) -> AsyncIterator[ModelReadV2Res]: ...
    async def model_delete_v2(self, req: ModelDeleteV2Req) -> ModelDeleteV2Res: ...
    ...
    ) -> AsyncIterator[EvaluationRunReadV2Res]: ...
    ...
    async def prediction_read_v2(
        self, req: PredictionReadV2Req
    ) -> PredictionReadV2Res: ...
    async def prediction_list_v2(
        self, req: PredictionListV2Req
    ) -> AsyncIterator[PredictionReadV2Res]: ...
    ...
    # Scores
    async def score_create_v2(self, req: ScoreCreateV2Req) -> ScoreCreateV2Res: ...
    async def score_read_v2(self, req: ScoreReadV2Req) -> ScoreReadV2Res: ...
    async def score_list_v2(
        self, req: ScoreListV2Req
    ) -> AsyncIterator[ScoreReadV2Res]: ...
    async def score_delete_v2(self, req: ScoreDeleteV2Req) -> ScoreDeleteV2Res: ...
