...
def _get_resolver() -> Any:
    ...
    from weave.type_wrappers.Content import python_magic_resolver  # noqa: PLC0415

    if python_magic_resolver.is_available():
        _resolver = python_magic_resolver
        return _resolver

    from weave.type_wrappers.Content import polyfile_magic_resolver  # noqa: PLC0415
