...
#     filename: str
#     size: int
#     source_type: str # The python type or class which this content was created from
#
# class RawContentArgs(TypedDict):
#     input: Any
#     mimetype: str | None
#     extension: str | None
#
# class ValidatedContentArgs(TypedDict):
...
#     data: bytes
#
# class ResolvedContentProperties(ContentMetadata):
#     data: bytes
#     original_path: str | None

# def coerce_input(input: Any, **kwargs) -> :
