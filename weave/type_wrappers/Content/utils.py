...
from weave.type_wrappers.Content.content_types import DataUrl, DataUrlBase64, DataUrlBase64WithEncoding, DataUrlSimple, DataUrlWithEncoding
...
def try_parse_data_url(url: str) -> DataUrl | None:
    ...
    if encoding and is_base64:
        return DataUrl(params=DataUrlBase64WithEncoding(
        ...
        return DataUrl(params=DataUrlWithEncoding(
            mimetype=base_media_type,
            data=data_bytes,
        ...
        return DataUrl(params=DataUrlBase64(
            mimetype=base_media_type,
            data=data_bytes,
            content_type='data_url:base64',
        ))
    return DataUrl(params=DataUrlSimple(
        mimetype=base_media_type,
        data=data_bytes,
