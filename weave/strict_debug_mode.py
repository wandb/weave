...
class _StrictDebugLog:
    ...
    def analyze(self) -> typing.Optional[str]:
        ...
        if isinstance(input_type_args, op_args.OpNamedArgs):
            ...
            provided_input_value_type = typing.cast(
                types.TypedDict, types.TypeRegistry.type_of(provided_input_values)
            ...
            for input_key, (expected, provided, value_type) in zip(
                input_arg_names,
                zip(
                    expected_input_type.values(),
                    provided_input_types,
                    provided_input_value_type,
                ),
            ):
                ...
                if isinstance(provided, types.Const):
                    value_type = types.Const(
                        value_type, provided_input_values[input_key]
                    )
