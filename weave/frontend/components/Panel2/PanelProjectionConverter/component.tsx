...
export const PanelProjectionConverter: React.FC<PanelProjectionConverterProps> =
  props => {
    throw new Error('PanelProjectionConverter: cannot be rendered directly');
  };

export const PanelProjectionConverterConfig: React.FC<PanelProjectionConverterProps> =
  props => {
...
> = props => {
  ...
  const pConfig = useMemo(
    () => PUtil.processConfig<typeof PTypes.ProjectableType>(config, input),
    [config, input]
  );
