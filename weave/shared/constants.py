"""Constants shared by the Weave client and trace server.

They live here rather than in ``weave.trace_server.constants`` because the
client may not import the trace server. ``weave.trace_server.constants``
