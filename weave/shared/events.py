...
class ObjSchemaForInsertLike(Protocol):
    project_id: str
    object_id: str
...
class ObjCreateReqLike(Protocol):
    obj: ObjSchemaForInsertLike


class TableSchemaForInsertLike(Protocol):
    project_id: str
    rows: list[dict[str, Any]]


class TableCreateReqLike(Protocol):
    table: TableSchemaForInsertLike


class FileCreateReqLike(Protocol):
    project_id: str
    name: str
    content: bytes
...
def build_obj_create_event(req: ObjCreateReqLike) -> LocalEventEnvelope:
...
def build_table_create_event(req: TableCreateReqLike) -> LocalEventEnvelope:
...
def build_file_create_event(req: FileCreateReqLike) -> LocalEventEnvelope:
