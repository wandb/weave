...
from weave.shared.trace_server.agents.constants import (
...
from weave.shared.trace_server.agents.schema import (
    NormalizedMessage,
    SpanKindLiteral,
    StatusCodeLiteral,
)
from weave.shared.trace_server.interface.feedback_types import AgentSpanFeedbackType
from weave.shared.trace_server.interface.query import Query
from weave.shared.trace_server.sensitive_data.policy import SensitiveDataPolicy

if TYPE_CHECKING:
    from weave.shared.trace_server.trace_server_interface import ProcessedResourceSpans
else:
