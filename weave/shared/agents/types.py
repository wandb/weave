...
from weave.shared.agents.schema import (
    NormalizedMessage,
    SpanKindLiteral,
    StatusCodeLiteral,
)
from weave.shared.feedback_types import AgentSpanFeedbackType
from weave.shared.query import Query
from weave.shared.sensitive_data_policy import SensitiveDataPolicy

if TYPE_CHECKING:
    from weave.shared.trace_server_interface import ProcessedResourceSpans
else:
