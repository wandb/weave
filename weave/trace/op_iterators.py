"""Iterator/accumulator helpers for op streaming."""
...
logger = logging.getLogger("weave.trace.op")
...
class _IteratorWrapper(Generic[V]):
    """Wrap an iterator to add lifecycle hooks."""
...
def _build_iterator_from_accumulator_for_op(
    ...
    acc: _Accumulator[S, V] = _Accumulator(accumulator)
