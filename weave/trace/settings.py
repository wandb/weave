...
class UserSettings(BaseModel):
    ...
    If True (default), uses the new calls_complete endpoint which batches complete
    ...
    If False, uses the legacy call_start/call_end endpoints which send start and
    end events separately.
