    ...
    def put(self, key: K, value: V) -> None:
        ...
        with self._lock:
            ...
            if 0 < self._max_size <= len(self._cache):
                self._cache.popitem(last=False)  # last=False removes the first item (least recently used)
...
class WeaveClientSendFileCache:
    ...
    def __init__(self, max_size: int = 1000) -> None:
        ...
        """
        self.cache: ThreadSafeLRUCache[str, Future[FileCreateRes]] = ThreadSafeLRUCache(max_size=max_size)
    ...
    def _key(self, req: FileCreateReq) -> str:
        ...
        """
        cache_key_bytes = (req.project_id + "/" + req.name + "/").encode("utf-8") + req.content
