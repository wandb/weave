...
class SqlTableURI(uris.WeaveURI):
    SCHEME = "sql-table"
    entity_name: str
    project_name: str
    ...
    def to_ref(self) -> "SqlTableRef":
        return SqlTableRef.from_uri(self)

    def with_path(self, path: str) -> "SqlTableURI":
        return SqlTableURI(
            self.name,
            self.version,
            self.entity_name,
...
class SqlTableRef(ref_base.Ref):
    def __init__(
        self,
        entity_name: str,
        project_name: str,
    ...
    @classmethod
    def from_uri(cls, uri: uris.WeaveURI) -> "SqlTableRef":
        if not isinstance(uri, SqlTableURI):
...
class GraphClientSql(GraphClient[WeaveRunObj]):
    ...
    def ref_is_own(self, ref: typing.Optional[ref_base.Ref]) -> bool:
        return isinstance(ref, SqlTableRef)
    ...
    def save_object(self, obj: typing.Any, name: str, branch_name: str) -> SqlTableRef:
        ...
        ref = SqlTableRef("entity", "project", "objects", id_, None, obj, None, None)
