...
@weave.op()
def hdbscan_cluster(data: list[list[float]], options: typing.Optional[HDBSCANOptions]) -> ops_arrow.ArrowWeaveList[typing.Optional[str]]:
    if options == None:
        options = {}  # type: ignore
    ...
    result = pa.compute.replace_with_mask(arr, item_is_null, pa.scalar(None, pa.int64()))
