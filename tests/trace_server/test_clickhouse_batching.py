                ...
                tsi.CallBatchStartMode(
                    ...
                    req=tsi.CallStartReq(
                        start=tsi.StartedCallSchemaForInsert(
                            ...
                            attributes={},
                            inputs={"input": make_base_64_content("SOME BASE64 CONTENT - 1" + string_suffix)},
                        )
                    )
                ),
                tsi.CallBatchStartMode(
                    ...
                    req=tsi.CallStartReq(
                        start=tsi.StartedCallSchemaForInsert(
                            ...
                            started_at=datetime.datetime.now(datetime.timezone.utc),
                            attributes={},
                            inputs={"input": make_base_64_content("SOME BASE64 CONTENT - 2" + string_suffix)},
                        )
                    )
                ),
                tsi.CallBatchStartMode(
                    ...
                    req=tsi.CallStartReq(
                        start=tsi.StartedCallSchemaForInsert(
                            ...
                            started_at=datetime.datetime.now(datetime.timezone.utc),
                            attributes={},
                            inputs={"input": make_base_64_content("SOME BASE64 CONTENT - 3" + string_suffix)},
                        )
                    )
                ),
            ]
