...
def test_wf_scoring_worker_check_cancellation():
    ...
    os.environ["WF_SCORING_WORKER_CHECK_CANCELLATION"] = "true"
    assert wf_scoring_worker_check_cancellation() is True
    os.environ["WF_SCORING_WORKER_CHECK_CANCELLATION"] = "True"
    assert wf_scoring_worker_check_cancellation() is True
    os.environ["WF_SCORING_WORKER_CHECK_CANCELLATION"] = "false"
    assert wf_scoring_worker_check_cancellation() is False
    os.environ["WF_SCORING_WORKER_CHECK_CANCELLATION"] = ""
    assert wf_scoring_worker_check_cancellation() is False
    os.environ["WF_SCORING_WORKER_CHECK_CANCELLATION"] = "invalid"
    assert wf_scoring_worker_check_cancellation() is False
    del os.environ["WF_SCORING_WORKER_CHECK_CANCELLATION"]
...
def test_wf_scoring_worker_kafka_consumer_group_id_override():
    ...
    os.environ["WF_SCORING_WORKER_KAFKA_CONSUMER_GROUP_ID"] = "test-group-id"
    assert wf_scoring_worker_kafka_consumer_group_id_override() == "test-group-id"
    os.environ["WF_SCORING_WORKER_KAFKA_CONSUMER_GROUP_ID"] = ""
    assert wf_scoring_worker_kafka_consumer_group_id_override() == ""
    os.environ["WF_SCORING_WORKER_KAFKA_CONSUMER_GROUP_ID"] = "another-group"
    assert wf_scoring_worker_kafka_consumer_group_id_override() == "another-group"
    del os.environ["WF_SCORING_WORKER_KAFKA_CONSUMER_GROUP_ID"]
