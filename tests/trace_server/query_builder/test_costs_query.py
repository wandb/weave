            ...
            llm_usage AS (
                ...
                SELECT
                    *,
                    ...
                    if(JSONHas(kv.2, 'gross_input_tokens'), JSONExtractInt(kv.2, 'gross_input_tokens'), if(JSONHas(kv.2, 'prompt_tokens'), JSONExtractInt(kv.2, 'prompt_tokens'), 0) + if(JSONHas(kv.2, 'input_tokens'), JSONExtractInt(kv.2, 'input_tokens'), 0)) AS prompt_tokens,
