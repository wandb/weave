...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Spelled-out UTC/GMT markers are accepted permissively (not strict ISO).
        ("2024-03-01 12:00:00 UTC", "2024-03-01 12:00:00.000000"),
        ("2024-03-01 12:00:00 gmt", "2024-03-01 12:00:00.000000"),
        ("  2024-03-01 12:00:00 UTC  ", "2024-03-01 12:00:00.000000"),
    ],
)
