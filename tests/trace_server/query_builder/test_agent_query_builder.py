...
_GROUPED_AGG_TAIL = """count() AS span_count,
               ...
               groupUniqArray(1000)(s.agent_name) AS agent_names,
               groupUniqArray(1000)(s.agent_version) AS agent_versions,
               groupUniqArray(1000)(s.provider_name) AS provider_names,
               groupUniqArray(1000)(s.request_model) AS request_models,
               groupUniqArray(1000)(s.conversation_name) AS conversation_names,
