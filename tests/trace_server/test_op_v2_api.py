...
def test_op_create_basic(trace_server):
    ...
    create_res = trace_server.object_interface.op_create(create_req)
...
def test_op_read_basic(trace_server):
    ...
    read_res = trace_server.object_interface.op_read(read_req)
...
def test_op_read_not_found(trace_server):
    ...
    with pytest.raises(NotFoundError):
        trace_server.object_interface.op_read(read_req)
...
def test_op_list_basic(trace_server):
    ...
    for name in op_names:
        ...
        trace_server.object_interface.op_create(create_req)

    # List all ops
    list_req = oi.OpListReq(project_id=project_id)
    ops = list(trace_server.object_interface.op_list(list_req))
...
def test_op_list_with_limit(trace_server):
    ...
    # List with a limit
    list_req = oi.OpListReq(project_id=project_id, limit=3)
    ops = list(trace_server.object_interface.op_list(list_req))
...
def test_op_list_with_offset(trace_server):
    ...
    # List with an offset
    list_req = oi.OpListReq(project_id=project_id, offset=2)
    ops = list(trace_server.object_interface.op_list(list_req))
...
def test_op_list_with_limit_and_offset(trace_server):
    ...
    # First page
    list_req1 = oi.OpListReq(project_id=project_id, limit=3, offset=0)
    ops1 = list(trace_server.object_interface.op_list(list_req1))
    assert len(ops1) == 3

    # Second page
    list_req2 = oi.OpListReq(project_id=project_id, limit=3, offset=3)
    ops2 = list(trace_server.object_interface.op_list(list_req2))
    assert len(ops2) == 3
...
def test_op_delete_single_version(trace_server):
    ...
    delete_res = trace_server.object_interface.op_delete(delete_req)
...
def test_op_delete_not_found(trace_server):
    ...
    with pytest.raises(NotFoundError):
        trace_server.object_interface.op_delete(delete_req)
