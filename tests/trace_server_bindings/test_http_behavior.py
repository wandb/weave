...
# Client-side batch envelopes and gap models; not part of the generated SDK
# (the calls_complete v2 and multipart file endpoints are excluded from the
# OpenAPI spec).
...
def shutdown(server: RemoteHTTPTraceServer) -> None:
