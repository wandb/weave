...
def test_ensure_project_exists_wrapper():
    ...
    with patch("weave.wandb_interface.project_creator._ensure_project_exists") as mock_ensure:
...
def test_ensure_project_exists_project_not_found_create_fails():
    ...
    with patch("weave.compat.wandb.Api") as mock_api_class:
        ...
        with pytest.raises(UnableToCreateProjectError, match="Failed to create project test_entity/test_project"):
