...
from weave.compat.wandb.util.netrc import Netrc, Credentials
...
def test_netrc_write_and_read():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert read_credentials["api.wandb.ai"]["password"] == "test_api_key_123456789012345678901234567890"
...
def test_netrc_read_malformed_file():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        with pytest.raises(Exception):  # Should raise netrc.NetrcParseError or similar
            netrc_manager.read()
...
def test_netrc_add_or_update_entry_new_file():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert credentials["api.wandb.ai"]["password"] == "test_api_key_123456789012345678901234567890"
...
def test_netrc_add_or_update_entry_existing_file():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert credentials["api.wandb.ai"]["password"] == "new_key_123456789012345678901234567890"
