...
media_cases = [
    ...
    SerializationTestCase(
        ...
        exp_json={
            ...
            "load_op": "weave:///shawn/test-project/op/load_weave.type_handlers.Audio.audio.Audio:XMyJ3WbkKSXYFV5yoeTPbhELY0EYWuH9NCIuPNXz620",
        },
        exp_objects=[
            {
                "object_id": "load_weave.type_handlers.Audio.audio.Audio",
                "digest": "XMyJ3WbkKSXYFV5yoeTPbhELY0EYWuH9NCIuPNXz620",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "vN9BPk9QtELG8CcIURcOgvKUaPDrfYLG0PH47ayEB94"},
                },
            }
        ],
        exp_files=[
            {
                "digest": "vN9BPk9QtELG8CcIURcOgvKUaPDrfYLG0PH47ayEB94",
    ...
    SerializationTestCase(
        ...
        exp_json={
            "_type": "CustomWeaveType",
            "load_op": "weave:///shawn/test-project/op/load_rich.markdown.Markdown:rbhvA3sIo4JKMbNiD4NtVXyoGiP9d9gqHJ20Iw9iiWk",
        ...
        exp_objects=[
            {
                ...
                "digest": "rbhvA3sIo4JKMbNiD4NtVXyoGiP9d9gqHJ20Iw9iiWk",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "tp6WcOAF27lrQXxkQE3hJUNQesJ7mdgTvSvezJ8QhOc"},
                },
            }
        ],
        exp_files=[
            {
                "digest": "tp6WcOAF27lrQXxkQE3hJUNQesJ7mdgTvSvezJ8QhOc",
    ...
    SerializationTestCase(
        ...
        exp_json={
            ...
            "load_op": "weave:///shawn/test-project/op/load_moviepy.video.VideoClip.VideoClip:plYZATmRdU1kMYRoisCX85QH303BnTSV8mO2iVJSow0",
        },
        exp_objects=[
            {
                "object_id": "load_moviepy.video.VideoClip.VideoClip",
                "digest": "plYZATmRdU1kMYRoisCX85QH303BnTSV8mO2iVJSow0",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "j2bL73RGsDHXiPBZodBI5d7S9HvpmEmnysGV5mWd9O0"},
                },
            }
        ],
        exp_files=[
            {
                "digest": "j2bL73RGsDHXiPBZodBI5d7S9HvpmEmnysGV5mWd9O0",
        ...
        exp_objects=[
            {
                ...
                "digest": "pHK80K8ec7lRHbNwjR2LjWQXRxAV8n5BmkixcTamz2k",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
