...
media_cases = [
    ...
    SerializationTestCase(
        ...
        exp_json={
            ...
            "load_op": "weave:///shawn/test-project/op/load_weave.type_handlers.Audio.audio.Audio:EjA2oBYhxvfoGYyGcAW6w9TXm1DLjTvclk0uQVcKkuw",
        },
        exp_objects=[
            {
                "object_id": "load_weave.type_handlers.Audio.audio.Audio",
                "digest": "EjA2oBYhxvfoGYyGcAW6w9TXm1DLjTvclk0uQVcKkuw",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "qdyrU56G1lbXoyIX3JAtoDeuRetpOnmhKciSq5LPzvY"},
                },
            }
        ],
        exp_files=[
            {
                "digest": "qdyrU56G1lbXoyIX3JAtoDeuRetpOnmhKciSq5LPzvY",
