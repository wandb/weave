...
media_cases = [
    ...
    SerializationTestCase(
        ...
        exp_json={
            ...
            "load_op": "weave:///shawn/test-project/op/load_weave.type_handlers.Audio.audio.Audio:siJuJBZwrYZ4AFh6gMmLpDdz5lFfWGxNZ0AoMh3yCdA",
        },
        exp_objects=[
            {
                "object_id": "load_weave.type_handlers.Audio.audio.Audio",
                "digest": "siJuJBZwrYZ4AFh6gMmLpDdz5lFfWGxNZ0AoMh3yCdA",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "gsT9RyqIR0AIq93jQmapXXdE7RSN18RtDE6vpjdXZcs"},
                },
            }
        ],
        exp_files=[
            {
                "digest": "gsT9RyqIR0AIq93jQmapXXdE7RSN18RtDE6vpjdXZcs",
    ...
    SerializationTestCase(
        ...
        exp_json={
            ...
            "load_op": "weave:///shawn/test-project/op/load_moviepy.video.VideoClip.VideoClip:vhZDRbwz71vTJWsRsLy0SjLplfe9FuPe0bRVJXRawAQ",
        },
        exp_objects=[
            {
                "object_id": "load_moviepy.video.VideoClip.VideoClip",
                "digest": "vhZDRbwz71vTJWsRsLy0SjLplfe9FuPe0bRVJXRawAQ",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "bJEt8KcyRgnzW6WQxFTk0rgWqWGw9aAgYYYX3kOEVZ0"},
                },
            }
        ],
        exp_files=[
            {
                "digest": "bJEt8KcyRgnzW6WQxFTk0rgWqWGw9aAgYYYX3kOEVZ0",
