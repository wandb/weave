        ...
        exp_objects=[
            ...
            },
            {
                ...
                "exp_val": {
                    ...
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "MqFC4mjZWQVAB2AkQZ1g4uNUee9_hkUY-LYArWmTEcU"},
                },
            },
            {
                ...
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "ZHD4K7uUDPT93NdVQO3I6F9Xah9AEceW_BSQXg1bZPM"},
                },
            },
            {
                "object_id": "MyScorer",
            ...
            },
            {
                ...
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "vY6VtT9xBAKNfqhozgQdWEGuijncPtmZLYKr-exUERY"},
                },
            },
            {
                ...
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "Y7lSNR7U-F_VtxWyD8GOE3CFXRWfdL-2n1mcYfbSErs"},
                },
            },
            {
                ...
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "mfCJxTVupdfb98h8MKgrx_xRwh4ZkEfjqVKvRKpzcZo"},
                },
            },
        ],
        exp_files=[
            {
                "digest": "MqFC4mjZWQVAB2AkQZ1g4uNUee9_hkUY-LYArWmTEcU",
            ...
            {
                "digest": "Y7lSNR7U-F_VtxWyD8GOE3CFXRWfdL-2n1mcYfbSErs",
                "exp_content": b"import weave\n\n@weave.op\ndef score(self, user_input: str, output: str) -> str:\n    return user_input in output\n",
            },
            {
                "digest": "mfCJxTVupdfb98h8MKgrx_xRwh4ZkEfjqVKvRKpzcZo",
            ...
            {
                "digest": "ZHD4K7uUDPT93NdVQO3I6F9Xah9AEceW_BSQXg1bZPM",
            ...
            {
                "digest": "vY6VtT9xBAKNfqhozgQdWEGuijncPtmZLYKr-exUERY",
        ...
        exp_objects=[
            ...
            },
            {
                ...
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "-as2vXvfwWcR6oyzCYBxZi9aBQNdrjiTFf9mwt2xR40"},
                },
            },
        ],
        exp_files=[
            {
                "digest": "-as2vXvfwWcR6oyzCYBxZi9aBQNdrjiTFf9mwt2xR40",
                "exp_content": b"import weave\n\n@weave.op\ndef predict(self, user_input: str) -> str:\n    return self.prompt.format(user_input=user_input)\n",
            }
        ],
        # Sad ... equality is really a pain to assert here (and is broken)
