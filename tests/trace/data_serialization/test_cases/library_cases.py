...
library_cases = [
    SerializationTestCase(
        ...
        exp_json={
            ...
            "predict_and_score": "weave:///shawn/test-project/op/Evaluation.predict_and_score:vrnd8nKc78FhXHidNcdnFGm1fsDhjgXiVo7Yxw9lfp8",
        ...
        exp_objects=[
            ...
            },
            {
                ...
                "digest": "vrnd8nKc78FhXHidNcdnFGm1fsDhjgXiVo7Yxw9lfp8",
                "exp_val": {
                    "_type": "CustomWeaveType",
                    "weave_type": {"type": "Op"},
                    "files": {"obj.py": "1aFw9FpriW2yBnYKHhNXgvhHhrrCzyYLXZmb55Rm9bM"},
                },
            },
            {
                "object_id": "MyScorer",
