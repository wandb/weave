...
class _FakeResolver:
    """Minimal stand-in for ProjectIdResolver used in serialize tests."""

    def __init__(self, mapping: dict[str, str] | None = None) -> None:
        self._mapping = mapping or {}

    def resolve(self, project_id: str) -> str | None:
        return self._mapping.get(project_id)


class DummyClient:
    def __init__(self, resolved_project_ids: dict[str, str] | None = None) -> None:
        self.project_id_resolver = _FakeResolver(resolved_project_ids)
