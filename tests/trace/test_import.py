...
from scripts.benchmarks.tracing_overhead import time_weave_import


def test_import_not_slow(monkeypatch):
    """Test that weave import time is within acceptable limits using benchmarking data.

    This test uses the benchmarking functions from
    scripts/benchmarks/tracing_overhead.py to measure import performance.
    """
