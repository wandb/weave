...
def test_auto_mode_calls_delete(
    ...
    assert verify_call_deleted_in_table(
        client, clickhouse_client, project_id, call_id_1, "calls_complete"
    )
    assert verify_call_deleted_in_table(
        client, clickhouse_client, project_id, call_id_2, "calls_complete"
    )

    # Verify third call is still not deleted
    assert not verify_call_deleted_in_table(
        client, clickhouse_client, project_id, call_id_3, "calls_complete"
    )
