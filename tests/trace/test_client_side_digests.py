...
def _configure_digests(client: WeaveClient, *, enable: bool) -> None:
    ...
    client.project_id_resolver.invalidate(client._project_id())
...
def test_cross_project_ref_matches_string_ref_serialization(
    ...
    other_internal_project_id = client.project_id_resolver.resolve(
...
def test_http_422_does_not_disable_fast_path(
    ...
    assert not client.project_id_resolver.is_disabled
