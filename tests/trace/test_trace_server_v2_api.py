...
class TestOpsV2API:
    ...
    def test_op_create(self, client):
        ...
        res = client.server.object_interface.op_create(req)
    ...
    def test_op_read(self, client):
        ...
        create_req = oi.OpCreateReq(
            project_id=project_id,
            name="readable_op",
            source_code=source_code,
        )
        create_res = client.server.object_interface.op_create(create_req)

        # Read the op
        read_req = oi.OpReadReq(
            project_id=project_id,
            object_id="readable_op",
            digest=create_res.digest,
        )
        read_res = client.server.object_interface.op_read(read_req)
    ...
    def test_op_list_v2(self, client):
        ...
        for i in range(3):
            ...
            client.server.object_interface.op_create(req)

        # List ops
        list_req = oi.OpListReq(project_id=project_id)
        ops = list(client.server.object_interface.op_list(list_req))
    ...
    def test_op_list_v2_with_limit(self, client):
        ...
        # List ops with limit
        list_req = oi.OpListReq(project_id=project_id, limit=2)
        ops = list(client.server.object_interface.op_list(list_req))
    ...
    def test_op_delete_v2(self, client):
        ...
        # Delete the op
        delete_req = oi.OpDeleteReq(
            project_id=project_id,
            object_id="deletable_op",
            digests=[create_res.digest],
        )
        delete_res = client.server.object_interface.op_delete(delete_req)
...
class TestDatasetsV2API:
    ...
    def test_dataset_create_v2(self, client):
        ...
        res = client.server.object_interface.dataset_create(req)
    ...
    def test_dataset_read_v2(self, client):
        ...
        create_res = client.server.object_interface.dataset_create(create_req)
        ...
        read_res = client.server.object_interface.dataset_read(read_req)
    ...
    def test_dataset_list_v2(self, client):
        ...
        for i in range(3):
            ...
            client.server.object_interface.dataset_create(req)

        # List datasets
        list_req = oi.DatasetListReq(project_id=project_id)
        datasets = list(client.server.object_interface.dataset_list(list_req))
    ...
    def test_dataset_delete_v2(self, client):
        ...
        delete_res = client.server.object_interface.dataset_delete(delete_req)
...
class TestScorersV2API:
    ...
    def test_scorer_create_v2(self, client):
        ...
        # Create a scorer
        req = oi.ScorerCreateReq(
            project_id=project_id,
            name="test_scorer",
            description="A test scorer",
            op_source_code="def score(output, target):\n    return output == target",
        )
        res = client.server.object_interface.scorer_create(req)
    ...
    def test_scorer_read_v2(self, client):
        ...
        create_req = oi.ScorerCreateReq(
            project_id=project_id,
            name="accuracy_scorer",
            description="Measures accuracy",
            op_source_code=source_code,
        )
        create_res = client.server.object_interface.scorer_create(create_req)

        # Read the scorer
        read_req = oi.ScorerReadReq(
            project_id=project_id,
            object_id=create_res.object_id,
            digest=create_res.digest,
        )
        read_res = client.server.object_interface.scorer_read(read_req)
    ...
    def test_scorer_list_v2(self, client):
        ...
        for i in range(3):
            ...
            client.server.object_interface.scorer_create(req)

        # List scorers
        list_req = oi.ScorerListReq(project_id=project_id)
        scorers = list(client.server.object_interface.scorer_list(list_req))
    ...
    def test_scorer_delete_v2(self, client):
        ...
        # Delete the scorer
        delete_req = oi.ScorerDeleteReq(
            project_id=project_id,
            object_id=create_res.object_id,
            digests=[create_res.digest],
        )
        delete_res = client.server.object_interface.scorer_delete(delete_req)
...
class TestEvaluationsV2API:
    ...
    def test_evaluation_create_v2(self, client):
        ...
        dataset_req = oi.DatasetCreateReq(
            project_id=project_id,
            name="eval_dataset",
            rows=[{"input": "test", "output": "result"}],
        )
        dataset_res = client.server.object_interface.dataset_create(dataset_req)
        ...
        res = client.server.object_interface.evaluation_create(req)
    ...
    def test_evaluation_read_v2(self, client):
        ...
        eval_req = oi.EvaluationCreateReq(
            project_id=project_id,
        ...
        eval_res = client.server.object_interface.evaluation_create(eval_req)

        # Read the evaluation
        read_req = oi.EvaluationReadReq(
            project_id=project_id,
            object_id=eval_res.object_id,
            digest=eval_res.digest,
        )
        read_res = client.server.object_interface.evaluation_read(read_req)
    ...
    def test_evaluation_list_v2(self, client):
        ...
        for i in range(3):
            ...
            client.server.object_interface.evaluation_create(req)

        # List evaluations
        list_req = oi.EvaluationListReq(project_id=project_id)
        evaluations = list(client.server.object_interface.evaluation_list(list_req))
    ...
    def test_evaluation_delete_v2(self, client):
        ...
        delete_req = oi.EvaluationDeleteReq(
            project_id=project_id,
            object_id=eval_res.object_id,
            digests=[eval_res.digest],
        )
        delete_res = client.server.object_interface.evaluation_delete(delete_req)
    ...
    def test_evaluation_with_scorers(self, client):
        ...
        # Create scorers
        scorer_req1 = oi.ScorerCreateReq(
            project_id=project_id,
            name="scorer_1",
            op_source_code="def score1():\n    return 1",
        )
        scorer_res1 = client.server.object_interface.scorer_create(scorer_req1)

        scorer_req2 = oi.ScorerCreateReq(
            project_id=project_id,
            name="scorer_2",
            op_source_code="def score2():\n    return 2",
        )
        scorer_res2 = client.server.object_interface.scorer_create(scorer_req2)
...
class TestV2APIIntegration:
    ...
    def test_complete_evaluation_workflow(self, client):
        ...
        # Read evaluation
        eval_read_req = oi.EvaluationReadReq(
            project_id=project_id,
            object_id=eval_res.object_id,
            digest=eval_res.digest,
        )
        eval_read_res = client.server.object_interface.evaluation_read(eval_read_req)
        ...
        dataset_read_req = oi.DatasetReadReq(
            project_id=project_id,
            object_id=dataset_res.object_id,
            digest=dataset_res.digest,
        )
        dataset_read_res = client.server.object_interface.dataset_read(dataset_read_req)
        assert dataset_read_res.name == "workflow_dataset"

        # Verify we can read the scorers
        scorer1_read_req = oi.ScorerReadReq(
            project_id=project_id,
            object_id=exact_match_res.object_id,
            digest=exact_match_res.digest,
        )
        scorer1_read_res = client.server.object_interface.scorer_read(scorer1_read_req)
        assert scorer1_read_res.name == "exact_match"

        scorer2_read_req = oi.ScorerReadReq(
            project_id=project_id,
            object_id=length_res.object_id,
            digest=length_res.digest,
        )
        scorer2_read_res = client.server.object_interface.scorer_read(scorer2_read_req)
...
""",
        ...
        res = client.server.object_interface.model_create(req)
...
"""
        ...
        create_res = client.server.object_interface.model_create(create_req)

        # Read the model
        read_req = oi.ModelReadReq(
            project_id=project_id,
            object_id=create_res.object_id,
            digest=create_res.digest,
        )
        read_res = client.server.object_interface.model_read(read_req)
...
""",
            ...
            client.server.object_interface.model_create(req)

        # List models
        list_req = oi.ModelListReq(project_id=project_id)
        models = list(client.server.object_interface.model_list(list_req))
...
""",
        ...
        # Delete the model
        delete_req = oi.ModelDeleteReq(
            project_id=project_id,
            object_id=create_res.object_id,
            digests=[create_res.digest],
        )
        delete_res = client.server.object_interface.model_delete(delete_req)
...
""",
        ...
        model_res = client.server.object_interface.model_create(model_req)

        # Create evaluation run
        run_req = oi.EvaluationRunCreateReq(
            project_id=project_id,
            evaluation=eval_res.evaluation_ref,
            model=model_res.model_ref,
        )
        run_res = client.server.object_interface.evaluation_run_create(run_req)
...
""",
        ...
        read_req = oi.EvaluationRunReadReq(
            project_id=project_id,
            evaluation_run_id=run_res.evaluation_run_id,
        )
        read_res = client.server.object_interface.evaluation_run_read(read_req)
...
""",
        ...
        list_req = oi.EvaluationRunListReq(project_id=project_id)
        runs = list(client.server.object_interface.evaluation_run_list(list_req))
...
""",
        ...
        delete_req = oi.EvaluationRunDeleteReq(
            project_id=project_id,
            evaluation_run_ids=[run_res.evaluation_run_id],
        )
        delete_res = client.server.object_interface.evaluation_run_delete(delete_req)
...
""",
        ...
        finish_req = oi.EvaluationRunFinishReq(
            project_id=project_id,
            evaluation_run_id=run_res.evaluation_run_id,
            summary={"accuracy": 0.95, "total": 100},
        )
        finish_res = client.server.object_interface.evaluation_run_finish(finish_req)
...
""",
        ...
        # Create prediction
        pred_req = oi.PredictionCreateReq(
            project_id=project_id,
            model=model_res.model_ref,
            inputs={"input": "test query"},
            output="prediction for test query",
        )
        pred_res = client.server.object_interface.prediction_create(pred_req)
...
""",
        ...
        # Read the prediction
        read_req = oi.PredictionReadReq(
            project_id=project_id,
            prediction_id=pred_res.prediction_id,
        )
        read_res = client.server.object_interface.prediction_read(read_req)
...
""",
        ...
        # List predictions
        list_req = oi.PredictionListReq(project_id=project_id)
        predictions = list(client.server.object_interface.prediction_list(list_req))
...
""",
        ...
        delete_req = oi.PredictionDeleteReq(
            project_id=project_id,
            prediction_ids=pred_ids,
        )
        delete_res = client.server.object_interface.prediction_delete(delete_req)
...
""",
        ...
        finish_req = oi.PredictionFinishReq(
            project_id=project_id,
            prediction_id=pred_res.prediction_id,
        )
        finish_res = client.server.object_interface.prediction_finish(finish_req)
        assert finish_res.success is True
...
class TestScoresV2API:
    ...
    def test_score_create_v2(self, client):
        ...
        # Create scorer
        scorer_req = oi.ScorerCreateReq(
            project_id=project_id,
            name="score_test_scorer",
            op_source_code="def score(output, target):\n    return 1.0",
        )
        scorer_res = client.server.object_interface.scorer_create(scorer_req)
...
""",
        ...
        # Create score
        score_req = oi.ScoreCreateReq(
            project_id=project_id,
            prediction_id=pred_res.prediction_id,
            scorer=scorer_ref,
            value=0.95,
        )
        score_res = client.server.object_interface.score_create(score_req)
...
""",
        ...
        # Read the score
        read_req = oi.ScoreReadReq(
            project_id=project_id,
            score_id=score_res.score_id,
        )
        read_res = client.server.object_interface.score_read(read_req)
...
""",
        ...
        # List scores
        list_req = oi.ScoreListReq(project_id=project_id)
        scores = list(client.server.object_interface.score_list(list_req))
...
""",
        ...
        # Delete the scores
        delete_req = oi.ScoreDeleteReq(
            project_id=project_id,
            score_ids=score_ids,
        )
        delete_res = client.server.object_interface.score_delete(delete_req)
