...
def test_dataset_row_ref(client):
    ...
    inner = d2.rows[0]["a"]
    exp_ref = "weave:///shawn/test-project/object/Dataset:9uuMyJ8d68YFA7DCNavkJlVzHZKuLAjFLZ8Rr0BTkBs/attr/rows/id/XfhC9dNA5D4taMvhKT4MKN2uce7F56Krsyv4Q6mvVMA/key/a"
    assert inner == 5
