...
def test_basic_sequence_operations():
    ...
    iterator = ThreadSafeInMemorySequence(iter(range(10)))
...
def test_empty_iterator():
    ...
    iterator = ThreadSafeInMemorySequence(iter([]))
...
def test_known_length():
    ...
    iterator = ThreadSafeInMemorySequence(iter(range(5)), known_length=5)
...
def test_multiple_iterations():
    ...
    data = list(range(5))
    iterator = ThreadSafeInMemorySequence(iter(data))
...
def test_index_out_of_range():
    ...
    iterator = ThreadSafeInMemorySequence(iter(range(5)))
...
def test_iterator_exhaustion():
    ...
    iterator = ThreadSafeInMemorySequence(CountingIterator())
