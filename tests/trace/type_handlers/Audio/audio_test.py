...
class TestWeaveAudio:
    ...
    @pytest.mark.parametrize("audio_file_and_fmt", [(TEST_MP3_FILE, "mp3"), (TEST_WAV_FILE, "wav")])
    def test_publish_audio_from_decoded_bytes(self, client: WeaveClient, audio_file_and_fmt: str) -> None:
    ...
    @pytest.mark.parametrize("audio_file_and_fmt", [(TEST_MP3_FILE, "mp3"), (TEST_WAV_FILE, "wav")])
    def test_publish_audio_from_encoded_bytes(self, client: WeaveClient, audio_file_and_fmt: str) -> None:
        client.project = "test_audio_publish_from_bytes"
        audio_file, fmt = audio_file_and_fmt
        audio_bytes = open(audio_file, "rb").read()
