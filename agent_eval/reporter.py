...
def log_to_weave(
    ...
    for harness_key, task_results in results_by_harness.items():
        ...
        # Initialize EvaluationLogger for this model
        ...
        for task_result in task_results:
            ...
            # Build output dict with job results
            output = {
            ...
            # Add metrics if available from artifacts
            if artifacts_base_path:
                ...
                if task_artifacts_path:
                    ...
                    # Add workspace file list
                    workspace_files = _list_workspace_files(task_artifacts_path / "workspace")
                    if workspace_files:
                        output["workspace_files"] = workspace_files
