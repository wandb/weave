...
const sidebars: SidebarsConfig = {
  documentationSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'API',
      items: ['redoc'], // or 'swagger' if you used Swagger UI
    }
  ],
  apiReferenceSidebar: [{ type: "autogenerated", dirName: "api-reference" }],
  serviceApiReferenceSidebar: [{type: "autogenerated", dirName: "service-api"}],
  // [
  //   {
  //     type: 'category',
  //     label: 'API',
  //     items: require('./docs/service-api/sidebar.js'),
  //   },
  // ]
};
