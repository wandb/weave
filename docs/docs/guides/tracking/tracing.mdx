...
<Tabs groupId="client-layer">
    ...
    <TabItem value="service_api" label="HTTP API">
    To delete a call using the Service API, you can make a request to the [`/call/delete`](../../reference/service-api/calls-delete-calls-delete-post.api.mdx) endpoint.
