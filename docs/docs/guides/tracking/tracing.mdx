...
<Tabs groupId="programming-language">
  ...
  <TabItem value="typescript" label="TypeScript">
    Weave automatically tracks [calls to common LLM libraries](../integrations/index.md) like `openai`. Simply call [`await weave.init('project_name')`](../../reference/typescript-sdk/weave/index.md#function-init) and wrap your OpenAI client with [`weave.wrapOpenAI`](../../reference/typescript-sdk/weave/index.md#function-wrapopenai) at the start of your program:
...
<Tabs groupId="programming-language">
  ...
  <TabItem value="typescript" label="TypeScript">
    Weave allows you to manually track these calls by wrapping your function with [`weave.op`](../../reference/typescript-sdk/weave/index.md#function-op). For example:
