...
| ------------------ | ----------------------------------------- | ------------ | -------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| Alibaba Qwen3 235B A22B | alibaba/Qwen3-235B-A22B-Instruct-2507 | Text         | 128K           | 22B - 235B (Active - Total) | Multilingual, instruction-tuned Mixture-of-Experts model optimized for logical reasoning, math, code, and tool usage. Strong performance on benchmarks like AIME, HMMT, Arena-Hard, and WritingBench. |
