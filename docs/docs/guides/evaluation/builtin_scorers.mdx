...
<Tabs groupId="programming-language" queryString>
  <TabItem value="python" label="Python" default>
    ...
    **Parameters:**
    ...
    [Verdict](https://github.com/haizelabs/verdict) is a library for creating arbitrary execution graphs of chained LLM judge calls. In other words, Verdict scales up judge-time compute.
