...
<Tabs groupId="programming-language" queryString>
  <TabItem value="python" label="Python" default>
    ...
    **LLM-evaluators**
    ...
    The pre-defined scorers that leverage LLMs now automatically integrate with litellm.
    ...
    **How It Works:**
    ...
    1. **Entity Density:** Checks the ratio of unique entities (like names, places, or things) mentioned in the summary to the total word count in the summary to estimate its information density. An LLM extracts the entities.
