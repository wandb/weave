...
You can try out the dashboard with your own Weave project by installing streamlit and running [the production dashboard script](https://github.com/NiWaRe/agent-dev-collection)!
