...
async def generate_screenshot_from_browser(
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            logging.exception(f"Error capturing screenshot for {url}: {e!s}")
            raise
...
def generate_screenshot(screenshot_spec):
    try:
        ...
        logging.exception(f"Failed to generate screenshot: {e!s}")
...
def generate_screenshots_from_spec(spec_filepath):
    try:
        ...
        logging.exception(f"Error reading or parsing spec file: {e!s}")
        return
