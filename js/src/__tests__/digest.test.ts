...
describe('stringifyPythonDumps', () => {
    ...
    test('Special numbers', () => {
        ...
        const expected2 = '{"exp_neg": 1e-100, "exp_pos": 1e+100, "float": 3.14159, "int_max": 9007199254740991, "int_min": -9007199254740991, "neg_zero": 0, "zero": 0}';
    ...
    test('Unicode and escaping', () => {
        ...
        const expected4 = '{"backslash": "C:\\\\path\\\\to\\\\file", "escape_chars": "\\b\\f\\n\\r\\t", "quotes": "\\"Hello,\\" she said.", "unicode": "こんにちは"}';
