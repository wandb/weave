...
export const FacetGridWrapper = styled.div<{rowHeight: number, columnWidth: number}>`
  display: grid;
...
export const xAxisLabel = styled.div<{gridRowStart: number, columnCount: number}>`
...
export const FacetHeaderCell = styled.div<{gridRowStart: number, gridColumnStart: number}>`
