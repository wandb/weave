...
const PLAYGROUND_PROMPT_GENERATOR_SYSTEM_PROMPT = `
# Context:
...
const BUTTON_TEXT = 'Generate';
const PLACEHOLDER = 'What are you interested in building?';

type PlaygroundSystemPromptMagicButtonProps = {} & Omit<
  React.ComponentProps<typeof MagicButton>,
  'systemPrompt' | 'placeholder' | 'text'
>;

export const PlaygroundSystemPromptMagicButton: React.FC<
  PlaygroundSystemPromptMagicButtonProps
> = props => {
  return (
    <MagicButton
