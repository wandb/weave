      ...
      <Box className="flex flex-col gap-8 pt-16">
        ...
        <Box className="flex flex-col gap-16 px-20">
          <Box>
            ...
            {(nameError || validationErrors?.scorerName) && (
              <Typography
          ...
          <Box>
            ...
            />
            {(judgeModelError || validationErrors?.judgeModel) && (
              <Typography
                className="mt-1 text-sm"
                sx={{
                  ...typographyStyle,
          ...
          {judgeModel && (
            <Box className="flex flex-col gap-8 rounded-md border border-moon-250 p-12">
              ...
              <Box>
                ...
                />
                {(judgeModelError || validationErrors?.judgeModelName) && (
                  <Typography
                    className="mt-1 text-sm"
                    sx={{
                      ...typographyStyle,
          ...
          <Box>
            ...
            />
            {(scoringPromptError || validationErrors?.scoringPrompt) && (
              <Typography
                className="mt-1 text-sm"
                sx={{
                  ...typographyStyle,
