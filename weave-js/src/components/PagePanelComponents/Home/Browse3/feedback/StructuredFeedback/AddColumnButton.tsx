...
const NumericalFeedbackComponent = ({
  ...
  <div className="flex flex-col">
    <span className="mb-2 text-xs text-moon-500">optional</span>
    <div className="flex items-center space-x-4 pb-8">
      <div className="w-full items-center">
        <span className="text-s mx-4 font-bold text-moon-600">min</span>
        <TextField
      ...
      <div className="w-full items-center">
        <span className="text-s mx-4 font-bold text-moon-600">max</span>
        <TextField
...
const CreateStructuredFeedbackModal = ({
  ...
  const [selectedFeedbackType, setSelectedFeedbackType] =
    useState<string>('Numerical feedback');
