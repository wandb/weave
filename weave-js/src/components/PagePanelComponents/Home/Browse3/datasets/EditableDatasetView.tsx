      ...
      renderCell: (params: GridRenderCellParams) => {
        ...
        const serverValue =
          rowIndex != null && !params.row.___weave?.isNew
            ? loadedRows[rowIndex - offset]?.val?.[params.field] ?? ''
            : '';
        return (
          <CellViewingRenderer
            {...params}
            isEdited={
              editedRow &&
              editedRow[field as string] !== undefined &&
              editedRow[field as string] !== serverValue
            }
            isDeleted={deletedRows.includes(params.row.___weave?.index)}
            isNew={params.row.___weave?.isNew}
          />
      ...
      renderEditCell: (params: GridRenderEditCellParams) => {
        ...
        const serverValue =
          rowIndex != null && !params.row.___weave?.isNew
            ? loadedRows[rowIndex - offset]?.val?.[params.field] ?? ''
            : '';
        return <CellEditingRenderer {...params} serverValue={serverValue} />;
      },
    }));
