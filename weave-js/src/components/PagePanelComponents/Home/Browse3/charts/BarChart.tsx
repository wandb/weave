...
import {aggregateValues, binDataPoints} from './chartCalculations';
import {
  AggregationMethod,
  COLOR_PALETTE,
  DataPoint,
...
import {createAxisTickFormatters} from './chartTickFormatters';
import {
  ChartAxisField,
  ExtractedCallData,
  getDisplayValue,
    ...
    <div style={tooltipContainerStyle(isFullscreen)}>
      ...
      <div
        ...
        <span
          ...
          {traceIdToDisplayName?.get(data.group) || data.group}
        </span>
        <span
          style={{
            flex: '0 0 auto',
