...
export type ChartProps = {
  ...
  isLoading?: boolean;
  evalChildrenData?: Map<string, ExtractedCallData[]>;
...
export const Chart: React.FC<ChartProps> = ({
  ...
  const effectiveGroupKey = React.useMemo(() => {
    if (groupByTraceId) {
      // For evaluations, group predict_and_score calls by their parent trace
      return 'traceId';
    }
    ...
    return undefined;
  }, [groupByTraceId, hasMultipleOperations]);
  ...
  const plotProps = {
    ...
    traceIdToDisplayName, // Pass the trace ID to display name mapping
    groupByTraceId, // Pass the evaluation flag for special x-axis handling
    ...(plotType === 'line' || plotType === 'bar'
  ...
  const chartContent = (
    <div
      ...
      style={{
        ...
        height: isFullscreen ? window.innerHeight - 140 : 410,
