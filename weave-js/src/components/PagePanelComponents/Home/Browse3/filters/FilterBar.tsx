    ...
    <>
      <div
        ...
        className={`border-box flex h-32 cursor-pointer items-center gap-4 rounded px-8 ${
          hasBorder
            ? 'border border-moon-200 outline-[1.5px] outline-solid outline-transparent hover:border-teal-400 hover:ring-1 hover:ring-teal-400 dark:border-moon-200 dark:hover:border-teal-400 dark:hover:outline-teal-400'
            : ''
        } ${
