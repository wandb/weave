...
export const TimestampRelative = ({value}: {value: string}) => {
  /* Assume relative format, just display str */
  const tooltip = parseDate(value);
  const text = (
  ...
  return <Tooltip content={tooltip} trigger={text} />;
};
