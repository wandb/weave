...
> {
  const parsed = safeParse(
    request,
    (value) => components.FeedbackCreateReq$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/feedback/create")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FeedbackCreateRes$inboundSchema),
