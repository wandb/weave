...
> {
  const parsed = safeParse(
    request,
    (value) => components.CostCreateReq$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/cost/create")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CostCreateRes$inboundSchema),
