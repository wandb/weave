...
> {
  const parsed = safeParse(
    request,
    (value) => components.TableUpdateReq$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/table/update")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TableUpdateRes$inboundSchema),
