...
> {
  const parsed = safeParse(
    request,
    (value) => components.TableCreateReq$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/table/create")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TableCreateRes$inboundSchema),
