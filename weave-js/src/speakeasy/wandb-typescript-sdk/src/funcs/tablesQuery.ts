...
> {
  const parsed = safeParse(
    request,
    (value) => components.TableQueryReq$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/table/query")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TableQueryRes$inboundSchema),
