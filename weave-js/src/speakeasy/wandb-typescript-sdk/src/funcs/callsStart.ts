 ...
 * Call Start
 */
export async function callsStart(
  client: WandbCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.CallStartReq$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/call/start")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CallStartRes$inboundSchema),
