...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.BodyFileCreateFileCreatePost$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/file/create")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FileCreateRes$inboundSchema),
