...
//
// import type {WeaveExpressionAction} from './types';
// import {
//   getSelectionIndex,
//   nodesAtOffset,
//   rangeForSyntaxNode,
//   trace,
// } from './util';
// import {SuggestionsProps} from '@wandb/weave/panel/WeaveExpression/suggestions';
// import {WeaveExpressionProps} from '@wandb/weave/panel/WeaveExpression/WeaveExpression';
//
// let instanceCounter = 0;
//
// export class WeaveExpressionState {
//   public readonly id: string; // move
//   // public readonly isBusy: boolean; // move
//   // public readonly isValid: boolean; // move
//   // public readonly isDirty: boolean; // true if expression has been modified
//   // public readonly isTruncated: boolean; // move
//   // public readonly slateValue: SlateNode[];
//   public readonly suggestions: SuggestionsProps;
...
//       'setExpression' | 'isLiveUpdateEnabled' | 'expr'
//     >,
//     // private readonly weave: WeaveInterface,
//     // private stack: Stack,
//     // these never gets redefined, i don't think.
...
//   // }
//
//   // parse the current editor text and update the expression
...
//   //   );
//   //
//   //   // If we have extra text, ignore the expression
...
//   //   // compares the old text with the new text
//   //   // do we really need to convert via expToString? or can we just compared editingText with newText?
//   //
//   //   if (newText === oldText) {
...
//   //   }
//   //
//   //   if (this.props.isLiveUpdateEnabled) {
//   //     if (
