// costs are from https://raw.githubusercontent.com/BerriAI/litellm/main/model_prices_and_context_window.json on Sept 12, 2024
// costs are in USD
...
export const LLM_TOKEN_COSTS = {
  ...
  'ft:gpt-3.5-turbo-0125': {input: 0.003, output: 0.006},
  'ft:gpt-3.5-turbo-1106': {input: 0.003, output: 0.006},
  'ft:gpt-3.5-turbo-0613': {input: 0.003, output: 0.006},
  'ft:gpt-4-0613': {input: 0.03, output: 0.06},
  'ft:gpt-4o-2024-08-06': {input: 0.00375, output: 0.015},
  ...
  'azure/gpt-4o-2024-08-06': {input: 0.00275, output: 0.011},
  'azure/global-standard/gpt-4o-2024-08-06': {input: 0.0025, output: 0.01},
  ...
  'cerebras/llama3.1-8b': {input: 0.0001, output: 0.0001},
  ...
  'gemini-1.5-flash-exp-0827': {input: 0.0005, output: 0.0015},
  'gemini-1.5-flash-001': {input: 0.0005, output: 0.0015},
  'gemini-1.5-flash-preview-0514': {input: 0.0005, output: 0.0015},
  'gemini-pro-experimental': {input: 0.0, output: 0.0},
  'gemini-pro-flash': {input: 0.0, output: 0.0},
  ...
  'vertex_ai/jamba-1.5-mini@001': {input: 0.0002, output: 0.0004},
  'vertex_ai/jamba-1.5-large@001': {input: 0.002, output: 0.008},
  'vertex_ai/jamba-1.5': {input: 0.0002, output: 0.0004},
  'vertex_ai/jamba-1.5-mini': {input: 0.0002, output: 0.0004},
  'vertex_ai/jamba-1.5-large': {input: 0.002, output: 0.008},
  ...
  'gemini/gemini-1.5-flash': {input: 7.5e-5, output: 0.0003},
  'gemini/gemini-1.5-flash-latest': {input: 7.5e-5, output: 0.0003},
  ...
  'gemini/gemini-1.5-pro-exp-0827': {input: 0.0035, output: 0.0105},
  ...
  'jamba-1.5-mini@001': {input: 0.0002, output: 0.0004},
  'jamba-1.5-large@001': {input: 0.002, output: 0.008},
  'jamba-1.5': {input: 0.0002, output: 0.0004},
  ...
  'eu.anthropic.claude-3-sonnet-20240229-v1:0': {input: 0.003, output: 0.015},
  'eu.anthropic.claude-3-5-sonnet-20240620-v1:0': {input: 0.003, output: 0.015},
  'eu.anthropic.claude-3-haiku-20240307-v1:0': {
    input: 0.00025,
    output: 0.00125,
  },
  'eu.anthropic.claude-3-opus-20240229-v1:0': {input: 0.015, output: 0.075},
  ...
  'databricks/databricks-llama-2-70b-chat': {input: 0.00050001, output: 0.0015},
  ...
  'databricks/databricks-mpt-7b-instruct': {input: 0.00050001, output: 0.0},
  'databricks/databricks-bge-large-en': {input: 0.00010003, output: 0.0},
  'databricks/databricks-gte-large-en': {input: 0.00012999, output: 0.0},
};
