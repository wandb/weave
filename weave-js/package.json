{
  ...
  "scripts": {
    ...
    "test": "jest",
    "testci": "CI=true JEST_JUNIT_OUTPUT_DIR=./test-results/junit jest --reporters=default --reporters=jest-junit",
  ...
  "devDependencies": {
    ...
    "eslint-plugin-wandb": "link:./eslint-plugin-wandb",
  ...
  "jest": {
    ...
    "moduleNameMapper": {
      "^@wandb/weave/(.*)$": "<rootDir>/src/$1",
      "\\.(wasm)$": "<rootDir>/mockTreeSitterForTest.js",
