...
def test_merge_from_local_with_commit_hash_onto_local_with_branch_and_branchpoint(
    ...
    merged_uri_2 = weave.legacy.weave.ops.merge_artifact(
        weave.legacy.weave.ops.get(merged_uri)
    )
...
def test_publish_saved_node(user_by_api_key_in_env):
    ...
    published_art_uri = weave.legacy.weave.ops.publish_artifact(
...
def test_end_to_end_save_and_publish_flow(user_by_api_key_in_env):
    ...
    published_merged_uri = weave.legacy.weave.ops.merge_artifact(
