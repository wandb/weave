...
#     )
#     chat_completions = weave.weave_query.monitoring.openai.openai.ChatCompletions(
#         mocked_create
#     )
#     create_input = dict(
#         model="gpt-3.5-turbo",
...
#     client,
# ):
#     chat_completions = weave.weave_query.monitoring.openai.openai.AsyncChatCompletions(
#         mocked_async_streaming_create
#     )
#     create_input = dict(
#         model="gpt-3.5-turbo",
