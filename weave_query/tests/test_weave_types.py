...
import weave_query
import weave_query
import weave_query.weave_types
from weave_query import _dict_utils, runs
...
def test_typeof_nested_dict_merge():
    ...
    t1 = weave_query.weave_types.TypedDict(
        {"a": weave_query.weave_types.TypedDict({"b": types.Int()})}
    )
    t2 = weave_query.weave_types.TypedDict(
        {"a": weave_query.weave_types.TypedDict({"c": types.String()})}
    )
    merged_type = _dict_utils.typeddict_merge_output_type({"self": t1, "other": t2})
    assert merged_type == weave_query.weave_types.TypedDict(
        {"a": weave_query.weave_types.TypedDict({"c": types.String()})}
    )
...
#     assert (
#         weave_query.weave_types.union(
#             weave_query.weave_types.String(), weave_query.weave_types.UnknownType()
#         )
#         == weave_query.weave_types.String()
#     )
#     assert (
#         weave_query.weave_types.union(
#             weave_query.weave_types.UnknownType(), weave_query.weave_types.UnknownType()
#         )
#         == weave_query.weave_types.UnknownType()
#     )
#     assert (
#         weave_query.weave_types.union(
#             weave_query.weave_types.UnknownType(),
...
def test_union_access():
    ...
    unioned = weave_query.weave_types.union(
        weave_query.weave_types.String(),
    ...
    unioned = weave_query.weave_types.union(
        weave_query.weave_types.List(weave_query.weave_types.String()),
        weave_query.weave_types.List(weave_query.weave_types.Number()),
    )
    assert unioned.object_type == weave_query.weave_types.union(
        weave_query.weave_types.String(), weave_query.weave_types.Number()
    )

    # Nullable type
    unioned = weave_query.weave_types.union(
        weave_query.weave_types.NoneType(),
        weave_query.weave_types.List(weave_query.weave_types.String()),
    )
    assert unioned.object_type == weave_query.weave_types.union(
        weave_query.weave_types.String(), weave_query.weave_types.NoneType()
    )
    ...
    # Combined dicts
    unioned = weave_query.weave_types.union(
        weave_query.weave_types.TypedDict(
            {
                "same": weave_query.weave_types.Number(),
                "solo_a": weave_query.weave_types.Number(),
                "differ": weave_query.weave_types.Number(),
            }
        ),
        weave_query.weave_types.TypedDict(
            {
                "same": weave_query.weave_types.Number(),
                "solo_b": weave_query.weave_types.String(),
    ...
    assert unioned.property_types == {
        "same": weave_query.weave_types.Number(),
        "solo_a": weave_query.weave_types.union(
            weave_query.weave_types.Number(), weave_query.weave_types.NoneType()
        ),
        "solo_b": weave_query.weave_types.union(
            weave_query.weave_types.String(), weave_query.weave_types.NoneType()
        ),
        "differ": weave_query.weave_types.union(
            weave_query.weave_types.Number(), weave_query.weave_types.String()
        ),
    }
    ...
    assert unioned.property_types == {
        "a": weave_query.weave_types.union(
            weave_query.weave_types.String(), weave_query.weave_types.NoneType()
        )
    }
