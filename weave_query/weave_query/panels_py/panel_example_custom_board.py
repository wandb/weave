...
def board(
    ...
    control_items = [
        ...
        weave.legacy.weave.panels.GroupPanel(input_node, id="data"),
    ]
    ...
    panels = [
        weave.legacy.weave.panels.BoardPanel(title_var, id="title_panel"),
        weave.legacy.weave.panels.BoardPanel(data_var, id="table"),
    ]
