...
@weave.op()
def module_doc(module: types.ModuleType) -> weave_query.ops.Markdown:
    return weave_query.ops.Markdown(module.__doc__ or "")
...
@weave.op()
def pyclass_doc(pyclass: type) -> weave_query.ops.Markdown:
    return weave_query.ops.Markdown(pyclass.__doc__ or "")
...
@weave.op()
def function_doc(pyfunction: types.FunctionType) -> weave_query.ops.Markdown:
    return weave_query.ops.Markdown(pyfunction.__doc__ or "")
        ...
        return weave_query.panels.Card(
            ...
            content=[
                weave_query.panels.CardTab(
                    name="Description",
                    content=weave_query.panels.PanelMarkdown(module.module_doc()),  # type: ignore
                ),
                weave_query.panels.CardTab(
                    name="Classes",
                    content=weave_query.panels.Table(
                        ...
                        columns=[
                            lambda c: weave_query.panels.WeaveLink(
                                c.class_name(),
    ...
    def render(self) -> weave_query.panels.Card:
        ...
        return weave_query.panels.Card(
            ...
            content=[
                weave_query.panels.CardTab(
                    name="Description",
                    content=weave_query.panels.PanelMarkdown(cls.pyclass_doc()),  # type: ignore
                ),
                weave_query.panels.CardTab(
                    name="Methods",
                    content=weave_query.panels.Table(
                        ...
                        columns=[
                            lambda m: weave_query.panels.WeaveLink(
                                m.function_name(),
    ...
    def render(self) -> weave_query.panels.Card:
        ...
        return weave_query.panels.Card(
            ...
            content=[
                weave_query.panels.CardTab(
                    name="Description",
                    content=weave_query.panels.PanelMarkdown(func.function_doc()),  # type: ignore
                ),
            ],
        )
