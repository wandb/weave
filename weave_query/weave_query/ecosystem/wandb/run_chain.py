...
import weave
from weave.legacy.weave import compile, op_def, ops_arrow
from weave.legacy.weave.ecosystem.wandb import gql_artifact_dag
...
class RunChain:
    ...
    def _history_node(self):
        with op_def.no_refine():
            proj = weave.legacy.weave.ops.project(self.entity_name, self.project_name)
            history_nodes = []
            ...
            history_node = weave.legacy.weave.ops.List.concat(
