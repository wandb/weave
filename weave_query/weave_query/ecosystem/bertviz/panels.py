...
import weave_query
from weave_query.ecosystem import huggingface
...
def head_view(attention: huggingface.ModelOutputAttention) -> weave_query.ops.Html:
    ...
    return weave_query.ops.Html(html.data)
...
class BertvizHeadView(weave.Panel):
    ...
    def render(self) -> weave_query.panels.PanelHtml:
        ...
        return weave_query.panels.PanelHtml(html)
...
class BertvizModelView(weave.Panel):
    ...
    @weave.op()
    def model_view_panel_render(self) -> weave_query.panels.PanelHtml:
