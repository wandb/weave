...
def head_view(
    ...
    return weave.weave_query.ops.Html(html.data)
...
class BertvizHeadView(weave.Panel):
    ...
    def render(self) -> weave.weave_query.panels.PanelHtml:
        ...
        return weave.weave_query.panels.PanelHtml(html)
...
class BertvizModelView(weave.Panel):
    ...
    @weave.op()
    def model_view_panel_render(self) -> weave.weave_query.panels.PanelHtml:
