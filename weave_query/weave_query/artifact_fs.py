...
from weave_query import artifact_base, file_base, object_context, ref_base, uris
...
class FilesystemArtifact(artifact_base.Artifact):
    ...
    def as_node(self) -> "graph.Node":
        from weave_query.ops_primitives.weave_api import get as op_get
...
class FilesystemArtifactRef(artifact_base.ArtifactRef):
    ...
    def type(self) -> types.Type:
        ...
        if self.extra is not None:
            from weave_query import types_numpy
...
class FilesystemArtifactFile(file_base.File):
    ...
    def digest(self) -> typing.Optional[str]:
        from weave_query.artifact_wandb import WandbArtifact
