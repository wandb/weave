...
from weave_query import storage, errors, context_state, op_aliases, op_args, uris
from weave_query.op_args import OpNamedArgs
...
class Registry:
    ...
    def load_saved_ops(self):  # type: ignore
        from weave_query import op_def_type
