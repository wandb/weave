...
from weave_query.weave_query import context_state, decorator_class, object_type_ref_util, infer_types
    ...
    def wrap(target):
        ...
        if relocatable:
            for name, member in inspect.getmembers(target):
                from weave_query.weave_query import op_def, op_def_type
