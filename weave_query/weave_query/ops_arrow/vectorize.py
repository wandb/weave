...
from weave_query import errors,weavify, registry_mem
from weave_query import weave_types as types
from weave_query.api import op, use
from weave_query import dispatch, graph, graph_debug, op_args, op_def
from weave_query.arrow import convert
from weave_query.arrow.arrow import ArrowWeaveListType
from weave_query.arrow.arrow_tags import pushdown_list_tags
from weave_query.arrow.list_ import ArrowWeaveList
from weave_query.ops_arrow import arraylist_ops, convert_ops
from weave_query.ops_arrow.dict import preprocess_merge
...
def _create_manually_mapped_op(
    ...
    from weave_query.ops_arrow import dict
...
def _apply_fn_node(awl: ArrowWeaveList, fn: graph.OutputNode) -> ArrowWeaveList:
    ...
    from weave_query import execute_fast
