...
# that someone doesn't introduce auto-importing loading weave_query.weave_query.ops or weave_query.weave_query.panels
...
# introduce loading weave_query.weave_query.ops or weave_query.weave_query.panels when importing weave.
newly_added_modules = set(sys.modules.keys()) - pre_init_modules
ops_modules = []
panels_modules = []
for module_name in newly_added_modules:
    if module_name.startswith("weave_query.weave_query.ops"):
        ops_modules.append(module_name)
    if module_name.startswith("weave_query.weave_query.panels"):
...
if ops_modules or panels_modules:
    ...
    raise errors.WeaveInternalError(
        "importing weave should not import weave_query.weave_query.ops or weave_query.weave_query.panels, but the following modules were imported: "
